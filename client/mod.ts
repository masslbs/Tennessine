...
import { hexToBytes, hexToBigInt, toBytes } from "jsr:@wevm/viem";
import { PrivateKeyAccount } from "jsr:@wevm/viem/accounts";
// change to jsr, once new version is published
import { createSiweMessage } from "npm:viem/siwe";
...
export class RelayClient extends EventEmitter {
  ...
  ): Promise<void | Event | schema.ChallengeSolvedResponse | string> {
    if (
      !this.connection ||
