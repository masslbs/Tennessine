...
export namespace market {
  ...
  namespace mass {
    ...
    interface ISubscriptionPushRequest {
      ...
      sets?:
        | market.mass.SubscriptionPushRequest.ISequencedPartialPatchSet[]
        | null;
    }
    ...
    namespace SubscriptionPushRequest {
      ...
      class SequencedPartialPatchSet implements ISequencedPartialPatchSet {
         ...
         */
        public static toObject(
          message: market.mass.SubscriptionPushRequest.SequencedPartialPatchSet,
          options?: $protobuf.IConversionOptions,
        ): { [k: string]: any };
    ...
    class PatchSetWriteRequest implements IPatchSetWriteRequest {
       ...
       */
      public static create(
        properties?: market.mass.IPatchSetWriteRequest,
      ): market.mass.PatchSetWriteRequest;
       ...
       */
      public static encode(
        message: market.mass.IPatchSetWriteRequest,
        writer?: $protobuf.Writer,
      ): $protobuf.Writer;
       ...
       */
      public static toObject(
        message: market.mass.PatchSetWriteRequest,
        options?: $protobuf.IConversionOptions,
      ): { [k: string]: any };
