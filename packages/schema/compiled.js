    ...
    market.mass = (function() {
        ...
        mass.AuthenticateResponse = (function() {
            ...
            AuthenticateResponse.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.AuthenticateResponse();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.ChallengeSolvedResponse = (function() {
            ...
            ChallengeSolvedResponse.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.ChallengeSolvedResponse();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.ShopManifest = (function() {
            ...
            ShopManifest.encode = function encode(message, writer) {
                ...
                if (message.shopTokenId != null && Object.hasOwnProperty.call(message, "shopTokenId"))
                ...
                if (message.publishedTagId != null && Object.hasOwnProperty.call(message, "publishedTagId"))
                    writer.uint32(/* id 3, wireType 2 =*/26).bytes(message.publishedTagId);
                ...
                if (message.profilePictureUrl != null && Object.hasOwnProperty.call(message, "profilePictureUrl"))
                    writer.uint32(/* id 6, wireType 2 =*/50).string(message.profilePictureUrl);
            ...
            ShopManifest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.ShopManifest();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            ShopManifest.verify = function verify(message) {
                ...
                if (message.shopTokenId != null && message.hasOwnProperty("shopTokenId"))
                    if (!(message.shopTokenId && typeof message.shopTokenId.length === "number" || $util.isString(message.shopTokenId)))
            ...
            ShopManifest.fromObject = function fromObject(object) {
                if (object instanceof $root.market.mass.ShopManifest)
                    return object;
                ...
                if (object.shopTokenId != null)
                    if (typeof object.shopTokenId === "string")
                        $util.base64.decode(object.shopTokenId, message.shopTokenId = $util.newBuffer($util.base64.length(object.shopTokenId)), 0);
            ...
            ShopManifest.toObject = function toObject(message, options) {
                ...
                if (message.shopTokenId != null && message.hasOwnProperty("shopTokenId"))
                    object.shopTokenId = options.bytes === String ? $util.base64.encode(message.shopTokenId, 0, message.shopTokenId.length) : options.bytes === Array ? Array.prototype.slice.call(message.shopTokenId) : message.shopTokenId;
                if (message.publishedTagId != null && message.hasOwnProperty("publishedTagId"))
        ...
        mass.UpdateShopManifest = (function() {
             ...
             * @instance
             */
            Object.defineProperty(UpdateShopManifest.prototype, "_profilePictureUrl", {
             ...
             * @instance
             */
            Object.defineProperty(UpdateShopManifest.prototype, "_addAcceptedCurrency", {
             ...
             * @instance
             */
            Object.defineProperty(UpdateShopManifest.prototype, "_removeAcceptedCurrency", {
            ...
            UpdateShopManifest.encode = function encode(message, writer) {
                ...
                if (message.publishedTagId != null && Object.hasOwnProperty.call(message, "publishedTagId"))
                    writer.uint32(/* id 6, wireType 2 =*/50).bytes(message.publishedTagId);
                if (message.addPayee != null && Object.hasOwnProperty.call(message, "addPayee"))
                    $root.market.mass.UpdateShopManifest.Payee.encode(message.addPayee, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
                if (message.removePayee != null && Object.hasOwnProperty.call(message, "removePayee"))
                    $root.market.mass.UpdateShopManifest.Payee.encode(message.removePayee, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
                if (message.addAcceptedCurrency != null && Object.hasOwnProperty.call(message, "addAcceptedCurrency"))
                    $root.market.mass.ShopCurrency.encode(message.addAcceptedCurrency, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
                if (message.removeAcceptedCurrency != null && Object.hasOwnProperty.call(message, "removeAcceptedCurrency"))
                    $root.market.mass.ShopCurrency.encode(message.removeAcceptedCurrency, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
                if (message.setBaseCurrency != null && Object.hasOwnProperty.call(message, "setBaseCurrency"))
                    $root.market.mass.ShopCurrency.encode(message.setBaseCurrency, writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
                return writer;
            };
             ...
             * @returns {$protobuf.Writer} Writer
             */
            UpdateShopManifest.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            UpdateShopManifest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateShopManifest();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                    ...
                    case 7: {
                            message.addPayee = $root.market.mass.UpdateShopManifest.Payee.decode(reader, reader.uint32());
                            break;
                        }
                    case 8: {
                            message.removePayee = $root.market.mass.UpdateShopManifest.Payee.decode(reader, reader.uint32());
                            break;
                        }
                    case 9: {
                            message.addAcceptedCurrency = $root.market.mass.ShopCurrency.decode(reader, reader.uint32());
                            break;
                        }
                    case 10: {
                            message.removeAcceptedCurrency = $root.market.mass.ShopCurrency.decode(reader, reader.uint32());
                            break;
                        }
                    case 11: {
            ...
            UpdateShopManifest.verify = function verify(message) {
                ...
                if (message.addPayee != null && message.hasOwnProperty("addPayee")) {
                    ...
                    {
                        var error = $root.market.mass.UpdateShopManifest.Payee.verify(message.addPayee);
                        if (error)
                ...
                if (message.removePayee != null && message.hasOwnProperty("removePayee")) {
                    ...
                    {
                        var error = $root.market.mass.UpdateShopManifest.Payee.verify(message.removePayee);
                        if (error)
                            return "removePayee." + error;
                    }
                }
                if (message.addAcceptedCurrency != null && message.hasOwnProperty("addAcceptedCurrency")) {
                    properties._addAcceptedCurrency = 1;
                    {
                        var error = $root.market.mass.ShopCurrency.verify(message.addAcceptedCurrency);
                        if (error)
                            return "addAcceptedCurrency." + error;
                    }
                }
                if (message.removeAcceptedCurrency != null && message.hasOwnProperty("removeAcceptedCurrency")) {
                    properties._removeAcceptedCurrency = 1;
                    {
                        var error = $root.market.mass.ShopCurrency.verify(message.removeAcceptedCurrency);
                        if (error)
                            return "removeAcceptedCurrency." + error;
                    }
                }
            ...
            UpdateShopManifest.fromObject = function fromObject(object) {
                ...
                if (object.addPayee != null) {
                    if (typeof object.addPayee !== "object")
                        throw TypeError(".market.mass.UpdateShopManifest.addPayee: object expected");
                    message.addPayee = $root.market.mass.UpdateShopManifest.Payee.fromObject(object.addPayee);
                }
                if (object.removePayee != null) {
                    if (typeof object.removePayee !== "object")
                        throw TypeError(".market.mass.UpdateShopManifest.removePayee: object expected");
                    message.removePayee = $root.market.mass.UpdateShopManifest.Payee.fromObject(object.removePayee);
                }
                if (object.addAcceptedCurrency != null) {
                    if (typeof object.addAcceptedCurrency !== "object")
                        throw TypeError(".market.mass.UpdateShopManifest.addAcceptedCurrency: object expected");
                    message.addAcceptedCurrency = $root.market.mass.ShopCurrency.fromObject(object.addAcceptedCurrency);
                }
                if (object.removeAcceptedCurrency != null) {
                    if (typeof object.removeAcceptedCurrency !== "object")
                        throw TypeError(".market.mass.UpdateShopManifest.removeAcceptedCurrency: object expected");
                    message.removeAcceptedCurrency = $root.market.mass.ShopCurrency.fromObject(object.removeAcceptedCurrency);
                }
                if (object.setBaseCurrency != null) {
                    if (typeof object.setBaseCurrency !== "object")
                        throw TypeError(".market.mass.UpdateShopManifest.setBaseCurrency: object expected");
            ...
            UpdateShopManifest.toObject = function toObject(message, options) {
                ...
                if (message.profilePictureUrl != null && message.hasOwnProperty("profilePictureUrl")) {
                    object.profilePictureUrl = message.profilePictureUrl;
                    if (options.oneofs)
                        object._profilePictureUrl = "profilePictureUrl";
                }
                if (message.domain != null && message.hasOwnProperty("domain")) {
                    object.domain = message.domain;
                    if (options.oneofs)
                ...
                if (message.publishedTagId != null && message.hasOwnProperty("publishedTagId")) {
                    object.publishedTagId = options.bytes === String ? $util.base64.encode(message.publishedTagId, 0, message.publishedTagId.length) : options.bytes === Array ? Array.prototype.slice.call(message.publishedTagId) : message.publishedTagId;
                    if (options.oneofs)
                        object._publishedTagId = "publishedTagId";
                }
                if (message.addPayee != null && message.hasOwnProperty("addPayee")) {
                    object.addPayee = $root.market.mass.UpdateShopManifest.Payee.toObject(message.addPayee, options);
                    if (options.oneofs)
                        object._addPayee = "addPayee";
                }
                if (message.removePayee != null && message.hasOwnProperty("removePayee")) {
                    object.removePayee = $root.market.mass.UpdateShopManifest.Payee.toObject(message.removePayee, options);
                    if (options.oneofs)
                        object._removePayee = "removePayee";
                }
                if (message.addAcceptedCurrency != null && message.hasOwnProperty("addAcceptedCurrency")) {
                    object.addAcceptedCurrency = $root.market.mass.ShopCurrency.toObject(message.addAcceptedCurrency, options);
                    if (options.oneofs)
                        object._addAcceptedCurrency = "addAcceptedCurrency";
                }
                if (message.removeAcceptedCurrency != null && message.hasOwnProperty("removeAcceptedCurrency")) {
                    object.removeAcceptedCurrency = $root.market.mass.ShopCurrency.toObject(message.removeAcceptedCurrency, options);
                    if (options.oneofs)
            ...
            UpdateShopManifest.Payee = (function() {
                ...
                Payee.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateShopManifest.Payee();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
        ...
        mass.CreateItem = (function() {
            ...
            CreateItem.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.CreateItem();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.UpdateItem = (function() {
            ...
            UpdateItem.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateItem();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.CreateTag = (function() {
            ...
            CreateTag.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.CreateTag();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.UpdateTag = (function() {
            ...
            UpdateTag.encode = function encode(message, writer) {
                ...
                if (message.addItemId != null && Object.hasOwnProperty.call(message, "addItemId"))
                    writer.uint32(/* id 3, wireType 2 =*/26).bytes(message.addItemId);
                if (message.removeItemId != null && Object.hasOwnProperty.call(message, "removeItemId"))
            ...
            UpdateTag.verify = function verify(message) {
                ...
                if (message.addItemId != null && message.hasOwnProperty("addItemId")) {
                    ...
                    if (!(message.addItemId && typeof message.addItemId.length === "number" || $util.isString(message.addItemId)))
                        return "addItemId: buffer expected";
                }
                if (message.removeItemId != null && message.hasOwnProperty("removeItemId")) {
                    properties._removeItemId = 1;
                    if (!(message.removeItemId && typeof message.removeItemId.length === "number" || $util.isString(message.removeItemId)))
            ...
            UpdateTag.fromObject = function fromObject(object) {
                ...
                if (object.addItemId != null)
                    if (typeof object.addItemId === "string")
                        $util.base64.decode(object.addItemId, message.addItemId = $util.newBuffer($util.base64.length(object.addItemId)), 0);
                ...
                if (object.removeItemId != null)
                    if (typeof object.removeItemId === "string")
                        $util.base64.decode(object.removeItemId, message.removeItemId = $util.newBuffer($util.base64.length(object.removeItemId)), 0);
            ...
            UpdateTag.toObject = function toObject(message, options) {
                ...
                if (message.addItemId != null && message.hasOwnProperty("addItemId")) {
                    object.addItemId = options.bytes === String ? $util.base64.encode(message.addItemId, 0, message.addItemId.length) : options.bytes === Array ? Array.prototype.slice.call(message.addItemId) : message.addItemId;
                    if (options.oneofs)
                        object._addItemId = "addItemId";
                }
                if (message.removeItemId != null && message.hasOwnProperty("removeItemId")) {
                    object.removeItemId = options.bytes === String ? $util.base64.encode(message.removeItemId, 0, message.removeItemId.length) : options.bytes === Array ? Array.prototype.slice.call(message.removeItemId) : message.removeItemId;
                    if (options.oneofs)
                        object._removeItemId = "removeItemId";
                }
                if (message["delete"] != null && message.hasOwnProperty("delete")) {
        ...
        mass.ChangeStock = (function() {
            ...
            ChangeStock.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.ChangeStock();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.NewKeyCard = (function() {
            ...
            NewKeyCard.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.NewKeyCard();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.UpdateOrder = (function() {
            ...
            Object.defineProperty(UpdateOrder.prototype, "action", {
                get: $util.oneOfGetter($oneOfFields = ["changeItems", "itemsFinalized", "orderCanceled", "updateShippingDetails"]),
                set: $util.oneOfSetter($oneOfFields)
            });
            ...
            UpdateOrder.encode = function encode(message, writer) {
                ...
                if (message.itemsFinalized != null && Object.hasOwnProperty.call(message, "itemsFinalized"))
                    $root.market.mass.UpdateOrder.ItemsFinalized.encode(message.itemsFinalized, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                if (message.orderCanceled != null && Object.hasOwnProperty.call(message, "orderCanceled"))
                    $root.market.mass.UpdateOrder.OrderCanceled.encode(message.orderCanceled, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                if (message.updateShippingDetails != null && Object.hasOwnProperty.call(message, "updateShippingDetails"))
                    $root.market.mass.UpdateOrder.AddressDetails.encode(message.updateShippingDetails, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                return writer;
            };
            ...
            UpdateOrder.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 4: {
                            message.itemsFinalized = $root.market.mass.UpdateOrder.ItemsFinalized.decode(reader, reader.uint32());
                            break;
                        }
                    case 5: {
                            message.orderCanceled = $root.market.mass.UpdateOrder.OrderCanceled.decode(reader, reader.uint32());
                            break;
                        }
                    case 6: {
                            message.updateShippingDetails = $root.market.mass.UpdateOrder.AddressDetails.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            UpdateOrder.verify = function verify(message) {
                ...
                if (message.itemsFinalized != null && message.hasOwnProperty("itemsFinalized")) {
                    if (properties.action === 1)
                        return "action: multiple values";
                    properties.action = 1;
                    {
                        var error = $root.market.mass.UpdateOrder.ItemsFinalized.verify(message.itemsFinalized);
                        if (error)
                            return "itemsFinalized." + error;
                    }
                }
                if (message.orderCanceled != null && message.hasOwnProperty("orderCanceled")) {
                    if (properties.action === 1)
                        return "action: multiple values";
                    properties.action = 1;
                    {
                        var error = $root.market.mass.UpdateOrder.OrderCanceled.verify(message.orderCanceled);
                        if (error)
                            return "orderCanceled." + error;
                    }
                }
                if (message.updateShippingDetails != null && message.hasOwnProperty("updateShippingDetails")) {
                    if (properties.action === 1)
                        return "action: multiple values";
                    properties.action = 1;
                    {
                        var error = $root.market.mass.UpdateOrder.AddressDetails.verify(message.updateShippingDetails);
                        if (error)
                            return "updateShippingDetails." + error;
                    }
                }
                return null;
            };
            ...
            UpdateOrder.fromObject = function fromObject(object) {
                ...
                if (object.itemsFinalized != null) {
                    if (typeof object.itemsFinalized !== "object")
                        throw TypeError(".market.mass.UpdateOrder.itemsFinalized: object expected");
                    message.itemsFinalized = $root.market.mass.UpdateOrder.ItemsFinalized.fromObject(object.itemsFinalized);
                }
                if (object.orderCanceled != null) {
                    if (typeof object.orderCanceled !== "object")
                        throw TypeError(".market.mass.UpdateOrder.orderCanceled: object expected");
                    message.orderCanceled = $root.market.mass.UpdateOrder.OrderCanceled.fromObject(object.orderCanceled);
                }
                if (object.updateShippingDetails != null) {
                    if (typeof object.updateShippingDetails !== "object")
                        throw TypeError(".market.mass.UpdateOrder.updateShippingDetails: object expected");
                    message.updateShippingDetails = $root.market.mass.UpdateOrder.AddressDetails.fromObject(object.updateShippingDetails);
                }
                return message;
            };
            ...
            UpdateOrder.toObject = function toObject(message, options) {
                ...
                if (message.itemsFinalized != null && message.hasOwnProperty("itemsFinalized")) {
                    object.itemsFinalized = $root.market.mass.UpdateOrder.ItemsFinalized.toObject(message.itemsFinalized, options);
                    if (options.oneofs)
                        object.action = "itemsFinalized";
                }
                if (message.orderCanceled != null && message.hasOwnProperty("orderCanceled")) {
                    object.orderCanceled = $root.market.mass.UpdateOrder.OrderCanceled.toObject(message.orderCanceled, options);
                    if (options.oneofs)
                        object.action = "orderCanceled";
                }
                if (message.updateShippingDetails != null && message.hasOwnProperty("updateShippingDetails")) {
                    object.updateShippingDetails = $root.market.mass.UpdateOrder.AddressDetails.toObject(message.updateShippingDetails, options);
                    if (options.oneofs)
                        object.action = "updateShippingDetails";
                }
                return object;
            };
            ...
            UpdateOrder.ItemsFinalized = (function() {
                ...
                ItemsFinalized.encode = function encode(message, writer) {
                    ...
                    if (message.orderHash != null && Object.hasOwnProperty.call(message, "orderHash"))
                        writer.uint32(/* id 6, wireType 2 =*/50).bytes(message.orderHash);
                    if (message.currencyAddr != null && Object.hasOwnProperty.call(message, "currencyAddr"))
                        writer.uint32(/* id 7, wireType 2 =*/58).bytes(message.currencyAddr);
                    if (message.totalInCrypto != null && Object.hasOwnProperty.call(message, "totalInCrypto"))
                        writer.uint32(/* id 8, wireType 2 =*/66).bytes(message.totalInCrypto);
                    if (message.payeeAddr != null && Object.hasOwnProperty.call(message, "payeeAddr"))
                        writer.uint32(/* id 9, wireType 2 =*/74).bytes(message.payeeAddr);
                    if (message.isPaymentEndpoint != null && Object.hasOwnProperty.call(message, "isPaymentEndpoint"))
                        writer.uint32(/* id 10, wireType 0 =*/80).bool(message.isPaymentEndpoint);
                    if (message.shopSignature != null && Object.hasOwnProperty.call(message, "shopSignature"))
                        writer.uint32(/* id 11, wireType 2 =*/90).bytes(message.shopSignature);
                    return writer;
                };
                 ...
                 * @returns {$protobuf.Writer} Writer
                 */
                ItemsFinalized.encodeDelimited = function encodeDelimited(message, writer) {
                    return this.encode(message, writer).ldelim();
                };
                ...
                ItemsFinalized.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateOrder.ItemsFinalized();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                ItemsFinalized.verify = function verify(message) {
                    ...
                    if (message.orderHash != null && message.hasOwnProperty("orderHash"))
                        if (!(message.orderHash && typeof message.orderHash.length === "number" || $util.isString(message.orderHash)))
                            return "orderHash: buffer expected";
                    if (message.currencyAddr != null && message.hasOwnProperty("currencyAddr"))
                        if (!(message.currencyAddr && typeof message.currencyAddr.length === "number" || $util.isString(message.currencyAddr)))
                            return "currencyAddr: buffer expected";
                    if (message.totalInCrypto != null && message.hasOwnProperty("totalInCrypto"))
                        if (!(message.totalInCrypto && typeof message.totalInCrypto.length === "number" || $util.isString(message.totalInCrypto)))
                            return "totalInCrypto: buffer expected";
                    if (message.payeeAddr != null && message.hasOwnProperty("payeeAddr"))
                        if (!(message.payeeAddr && typeof message.payeeAddr.length === "number" || $util.isString(message.payeeAddr)))
                            return "payeeAddr: buffer expected";
                    if (message.isPaymentEndpoint != null && message.hasOwnProperty("isPaymentEndpoint"))
                    ...
                    if (message.shopSignature != null && message.hasOwnProperty("shopSignature"))
                        if (!(message.shopSignature && typeof message.shopSignature.length === "number" || $util.isString(message.shopSignature)))
                ...
                ItemsFinalized.fromObject = function fromObject(object) {
                    ...
                    if (object.orderHash != null)
                        if (typeof object.orderHash === "string")
                            $util.base64.decode(object.orderHash, message.orderHash = $util.newBuffer($util.base64.length(object.orderHash)), 0);
                    ...
                    if (object.currencyAddr != null)
                        if (typeof object.currencyAddr === "string")
                            $util.base64.decode(object.currencyAddr, message.currencyAddr = $util.newBuffer($util.base64.length(object.currencyAddr)), 0);
                    ...
                    if (object.totalInCrypto != null)
                        if (typeof object.totalInCrypto === "string")
                            $util.base64.decode(object.totalInCrypto, message.totalInCrypto = $util.newBuffer($util.base64.length(object.totalInCrypto)), 0);
                    ...
                    if (object.payeeAddr != null)
                        if (typeof object.payeeAddr === "string")
                            $util.base64.decode(object.payeeAddr, message.payeeAddr = $util.newBuffer($util.base64.length(object.payeeAddr)), 0);
                    ...
                    if (object.shopSignature != null)
                        if (typeof object.shopSignature === "string")
                            $util.base64.decode(object.shopSignature, message.shopSignature = $util.newBuffer($util.base64.length(object.shopSignature)), 0);
                ...
                ItemsFinalized.toObject = function toObject(message, options) {
                    ...
                    if (message.orderHash != null && message.hasOwnProperty("orderHash"))
                        object.orderHash = options.bytes === String ? $util.base64.encode(message.orderHash, 0, message.orderHash.length) : options.bytes === Array ? Array.prototype.slice.call(message.orderHash) : message.orderHash;
                    if (message.currencyAddr != null && message.hasOwnProperty("currencyAddr"))
                        object.currencyAddr = options.bytes === String ? $util.base64.encode(message.currencyAddr, 0, message.currencyAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.currencyAddr) : message.currencyAddr;
                    if (message.totalInCrypto != null && message.hasOwnProperty("totalInCrypto"))
                        object.totalInCrypto = options.bytes === String ? $util.base64.encode(message.totalInCrypto, 0, message.totalInCrypto.length) : options.bytes === Array ? Array.prototype.slice.call(message.totalInCrypto) : message.totalInCrypto;
                    if (message.payeeAddr != null && message.hasOwnProperty("payeeAddr"))
                        object.payeeAddr = options.bytes === String ? $util.base64.encode(message.payeeAddr, 0, message.payeeAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.payeeAddr) : message.payeeAddr;
                    if (message.isPaymentEndpoint != null && message.hasOwnProperty("isPaymentEndpoint"))
                        object.isPaymentEndpoint = message.isPaymentEndpoint;
                    if (message.shopSignature != null && message.hasOwnProperty("shopSignature"))
                        object.shopSignature = options.bytes === String ? $util.base64.encode(message.shopSignature, 0, message.shopSignature.length) : options.bytes === Array ? Array.prototype.slice.call(message.shopSignature) : message.shopSignature;
                    return object;
                };
            ...
            UpdateOrder.OrderCanceled = (function() {
                 ...
                 * @instance
                 */
                OrderCanceled.prototype.timestamp = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
                 ...
                 * @returns {$protobuf.Writer} Writer
                 */
                OrderCanceled.encodeDelimited = function encodeDelimited(message, writer) {
                    return this.encode(message, writer).ldelim();
                };
                ...
                OrderCanceled.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateOrder.OrderCanceled();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
            ...
            UpdateOrder.AddressDetails = (function() {
                ...
                AddressDetails.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateOrder.AddressDetails();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
        ...
        mass.ShopEvent = (function() {
            ...
            Object.defineProperty(ShopEvent.prototype, "union", {
                get: $util.oneOfGetter($oneOfFields = ["shopManifest", "updateShopManifest", "createItem", "updateItem", "createTag", "updateTag", "createOrder", "updateOrder", "changeStock", "newKeyCard"]),
                set: $util.oneOfSetter($oneOfFields)
            });
            ...
            ShopEvent.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.shopManifest != null && Object.hasOwnProperty.call(message, "shopManifest"))
                    $root.market.mass.ShopManifest.encode(message.shopManifest, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                if (message.updateShopManifest != null && Object.hasOwnProperty.call(message, "updateShopManifest"))
                    $root.market.mass.UpdateShopManifest.encode(message.updateShopManifest, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                ...
                if (message.updateTag != null && Object.hasOwnProperty.call(message, "updateTag"))
                    $root.market.mass.UpdateTag.encode(message.updateTag, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
                if (message.createOrder != null && Object.hasOwnProperty.call(message, "createOrder"))
                    $root.market.mass.CreateOrder.encode(message.createOrder, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
                if (message.updateOrder != null && Object.hasOwnProperty.call(message, "updateOrder"))
                    $root.market.mass.UpdateOrder.encode(message.updateOrder, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
                if (message.changeStock != null && Object.hasOwnProperty.call(message, "changeStock"))
                    $root.market.mass.ChangeStock.encode(message.changeStock, writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
                if (message.newKeyCard != null && Object.hasOwnProperty.call(message, "newKeyCard"))
                    $root.market.mass.NewKeyCard.encode(message.newKeyCard, writer.uint32(/* id 13, wireType 2 =*/106).fork()).ldelim();
                return writer;
            };
            ...
            ShopEvent.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    switch (tag >>> 3) {
                    case 2: {
                            message.shopManifest = $root.market.mass.ShopManifest.decode(reader, reader.uint32());
                            break;
                        }
                    case 3: {
                            message.updateShopManifest = $root.market.mass.UpdateShopManifest.decode(reader, reader.uint32());
                            break;
                        }
                    case 4: {
            ...
            ShopEvent.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                var properties = {};
                if (message.shopManifest != null && message.hasOwnProperty("shopManifest")) {
                    properties.union = 1;
                    {
                        var error = $root.market.mass.ShopManifest.verify(message.shopManifest);
                        if (error)
                            return "shopManifest." + error;
                    }
                }
                if (message.updateShopManifest != null && message.hasOwnProperty("updateShopManifest")) {
                    if (properties.union === 1)
                        return "union: multiple values";
                    properties.union = 1;
                    {
                        var error = $root.market.mass.UpdateShopManifest.verify(message.updateShopManifest);
                        if (error)
                            return "updateShopManifest." + error;
                    }
                }
                ...
                if (message.changeStock != null && message.hasOwnProperty("changeStock")) {
                    ...
                    properties.union = 1;
                    {
                        var error = $root.market.mass.ChangeStock.verify(message.changeStock);
                        if (error)
            ...
            ShopEvent.fromObject = function fromObject(object) {
                ...
                if (object.shopManifest != null) {
                    if (typeof object.shopManifest !== "object")
                        throw TypeError(".market.mass.ShopEvent.shopManifest: object expected");
                    message.shopManifest = $root.market.mass.ShopManifest.fromObject(object.shopManifest);
                }
                if (object.updateShopManifest != null) {
                    if (typeof object.updateShopManifest !== "object")
                        throw TypeError(".market.mass.ShopEvent.updateShopManifest: object expected");
                    message.updateShopManifest = $root.market.mass.UpdateShopManifest.fromObject(object.updateShopManifest);
                }
                if (object.createItem != null) {
                    if (typeof object.createItem !== "object")
                        throw TypeError(".market.mass.ShopEvent.createItem: object expected");
                ...
                if (object.updateItem != null) {
                    if (typeof object.updateItem !== "object")
                        throw TypeError(".market.mass.ShopEvent.updateItem: object expected");
                ...
                if (object.createTag != null) {
                    if (typeof object.createTag !== "object")
                        throw TypeError(".market.mass.ShopEvent.createTag: object expected");
                ...
                if (object.changeStock != null) {
                    if (typeof object.changeStock !== "object")
                        throw TypeError(".market.mass.ShopEvent.changeStock: object expected");
                ...
                if (object.newKeyCard != null) {
                    if (typeof object.newKeyCard !== "object")
                        throw TypeError(".market.mass.ShopEvent.newKeyCard: object expected");
            ...
            ShopEvent.toObject = function toObject(message, options) {
                ...
                var object = {};
                if (message.shopManifest != null && message.hasOwnProperty("shopManifest")) {
                    object.shopManifest = $root.market.mass.ShopManifest.toObject(message.shopManifest, options);
                    if (options.oneofs)
                        object.union = "shopManifest";
                }
                if (message.updateShopManifest != null && message.hasOwnProperty("updateShopManifest")) {
                    object.updateShopManifest = $root.market.mass.UpdateShopManifest.toObject(message.updateShopManifest, options);
                    if (options.oneofs)
                        object.union = "updateShopManifest";
                }
                if (message.createItem != null && message.hasOwnProperty("createItem")) {
        ...
        mass.ShopCurrency = (function() {
            ...
            ShopCurrency.encode = function encode(message, writer) {
                ...
                if (message.tokenAddr != null && Object.hasOwnProperty.call(message, "tokenAddr"))
            ...
            ShopCurrency.verify = function verify(message) {
                ...
                if (message.tokenAddr != null && message.hasOwnProperty("tokenAddr"))
                    if (!(message.tokenAddr && typeof message.tokenAddr.length === "number" || $util.isString(message.tokenAddr)))
            ...
            ShopCurrency.fromObject = function fromObject(object) {
                ...
                if (object.tokenAddr != null)
                    if (typeof object.tokenAddr === "string")
                        $util.base64.decode(object.tokenAddr, message.tokenAddr = $util.newBuffer($util.base64.length(object.tokenAddr)), 0);
            ...
            ShopCurrency.toObject = function toObject(message, options) {
                ...
                if (message.chainId != null && message.hasOwnProperty("chainId"))
                    if (typeof message.chainId === "number")
                        ...
                        object.chainId = options.longs === String ? $util.Long.prototype.toString.call(message.chainId) : options.longs === Number ? new $util.LongBits(message.chainId.low >>> 0, message.chainId.high >>> 0).toNumber(true) : message.chainId;
                if (message.tokenAddr != null && message.hasOwnProperty("tokenAddr"))
                    object.tokenAddr = options.bytes === String ? $util.base64.encode(message.tokenAddr, 0, message.tokenAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.tokenAddr) : message.tokenAddr;
                return object;
            };
        ...
        mass.CommitItemsToOrderRequest = (function() {
            ...
            CommitItemsToOrderRequest.encode = function encode(message, writer) {
                ...
                if (message.currency != null && Object.hasOwnProperty.call(message, "currency"))
                    $root.market.mass.ShopCurrency.encode(message.currency, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                if (message.payeeName != null && Object.hasOwnProperty.call(message, "payeeName"))
             ...
             * @returns {$protobuf.Writer} Writer
             */
            CommitItemsToOrderRequest.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            CommitItemsToOrderRequest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.CommitItemsToOrderRequest();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            CommitItemsToOrderRequest.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
            ...
            CommitItemsToOrderRequest.fromObject = function fromObject(object) {
                ...
                if (object.currency != null) {
                    if (typeof object.currency !== "object")
                        throw TypeError(".market.mass.CommitItemsToOrderRequest.currency: object expected");
             ...
             * @returns {string} The default type url
             */
            CommitItemsToOrderRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
        ...
        mass.CommitItemsToOrderResponse = (function() {
            ...
            CommitItemsToOrderResponse.encode = function encode(message, writer) {
                ...
                if (message.error != null && Object.hasOwnProperty.call(message, "error"))
                    $root.market.mass.Error.encode(message.error, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                if (message.orderFinalizedId != null && Object.hasOwnProperty.call(message, "orderFinalizedId"))
                    writer.uint32(/* id 3, wireType 2 =*/26).bytes(message.orderFinalizedId);
                return writer;
            };
             ...
             * @returns {$protobuf.Writer} Writer
             */
            CommitItemsToOrderResponse.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            CommitItemsToOrderResponse.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.CommitItemsToOrderResponse();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            CommitItemsToOrderResponse.decodeDelimited = function decodeDelimited(reader) {
                if (!(reader instanceof $Reader))
                    reader = new $Reader(reader);
                return this.decode(reader, reader.uint32());
            };
            ...
            CommitItemsToOrderResponse.verify = function verify(message) {
                ...
                if (message.orderFinalizedId != null && message.hasOwnProperty("orderFinalizedId"))
                    if (!(message.orderFinalizedId && typeof message.orderFinalizedId.length === "number" || $util.isString(message.orderFinalizedId)))
            ...
            CommitItemsToOrderResponse.fromObject = function fromObject(object) {
                ...
                if (object.error != null) {
                    if (typeof object.error !== "object")
                        throw TypeError(".market.mass.CommitItemsToOrderResponse.error: object expected");
                    message.error = $root.market.mass.Error.fromObject(object.error);
                }
                if (object.orderFinalizedId != null)
                    if (typeof object.orderFinalizedId === "string")
                        $util.base64.decode(object.orderFinalizedId, message.orderFinalizedId = $util.newBuffer($util.base64.length(object.orderFinalizedId)), 0);
             ...
             * @returns {Object.<string,*>} Plain object
             */
            CommitItemsToOrderResponse.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                var object = {};
                if (options.defaults) {
                    ...
                    if (options.bytes === String)
                        ...
                        object.orderFinalizedId = [];
                        if (options.bytes !== Array)
                            object.orderFinalizedId = $util.newBuffer(object.orderFinalizedId);
                    }
                }
                if (message.requestId != null && message.hasOwnProperty("requestId"))
                    object.requestId = options.bytes === String ? $util.base64.encode(message.requestId, 0, message.requestId.length) : options.bytes === Array ? Array.prototype.slice.call(message.requestId) : message.requestId;
                if (message.error != null && message.hasOwnProperty("error"))
                    object.error = $root.market.mass.Error.toObject(message.error, options);
                if (message.orderFinalizedId != null && message.hasOwnProperty("orderFinalizedId"))
                    object.orderFinalizedId = options.bytes === String ? $util.base64.encode(message.orderFinalizedId, 0, message.orderFinalizedId.length) : options.bytes === Array ? Array.prototype.slice.call(message.orderFinalizedId) : message.orderFinalizedId;
                return object;
            };
             ...
             * @returns {string} The default type url
             */
            CommitItemsToOrderResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
        ...
        mass.EventWriteRequest = (function() {
            ...
            EventWriteRequest.encode = function encode(message, writer) {
                ...
                if (message.requestId != null && Object.hasOwnProperty.call(message, "requestId"))
                    writer.uint32(/* id 1, wireType 2 =*/10).bytes(message.requestId);
                if (message.event != null && Object.hasOwnProperty.call(message, "event"))
                    $root.market.mass.SignedEvent.encode(message.event, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                return writer;
            };
        ...
        mass.EventWriteResponse = (function() {
            ...
            EventWriteResponse.encode = function encode(message, writer) {
                ...
                if (message.error != null && Object.hasOwnProperty.call(message, "error"))
                    $root.market.mass.Error.encode(message.error, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                if (message.newShopHash != null && Object.hasOwnProperty.call(message, "newShopHash"))
            ...
            EventWriteResponse.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.EventWriteResponse();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            EventWriteResponse.verify = function verify(message) {
                ...
                if (message.newShopHash != null && message.hasOwnProperty("newShopHash"))
                    if (!(message.newShopHash && typeof message.newShopHash.length === "number" || $util.isString(message.newShopHash)))
            ...
            EventWriteResponse.fromObject = function fromObject(object) {
                ...
                if (object.newShopHash != null)
                    if (typeof object.newShopHash === "string")
                        $util.base64.decode(object.newShopHash, message.newShopHash = $util.newBuffer($util.base64.length(object.newShopHash)), 0);
            ...
            EventWriteResponse.toObject = function toObject(message, options) {
                ...
                if (message.error != null && message.hasOwnProperty("error"))
                    object.error = $root.market.mass.Error.toObject(message.error, options);
                if (message.newShopHash != null && message.hasOwnProperty("newShopHash"))
                    object.newShopHash = options.bytes === String ? $util.base64.encode(message.newShopHash, 0, message.newShopHash.length) : options.bytes === Array ? Array.prototype.slice.call(message.newShopHash) : message.newShopHash;
                if (message.eventSequenceNo != null && message.hasOwnProperty("eventSequenceNo"))
        ...
        mass.EventPushRequest = (function() {
            ...
            EventPushRequest.encode = function encode(message, writer) {
                ...
                if (message.events != null && message.events.length)
                    for (var i = 0; i < message.events.length; ++i)
                        $root.market.mass.SignedEvent.encode(message.events[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                return writer;
            };
            ...
            EventPushRequest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.EventPushRequest();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.EventPushResponse = (function() {
            ...
            EventPushResponse.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.EventPushResponse();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.SyncStatusResponse = (function() {
            ...
            SyncStatusResponse.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.SyncStatusResponse();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.PingResponse = (function() {
            ...
            PingResponse.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.PingResponse();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
