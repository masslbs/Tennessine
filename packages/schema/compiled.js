    ...
    market.mass = (function() {
        ...
        mass.ObjectId = (function() {
            ...
            ObjectId.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.ObjectId();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.ShippingRegion = (function() {
             ...
             * @property {Array.<market.mass.IObjectId>|null} [orderPriceModifierIds] ShippingRegion orderPriceModifierIds
             */
            ...
            /**
             * ShippingRegion orderPriceModifierIds.
             * @member {Array.<market.mass.IObjectId>} orderPriceModifierIds
             * @memberof market.mass.ShippingRegion
             * @instance
             */
            ShippingRegion.prototype.orderPriceModifierIds = $util.emptyArray;
            ...
            ShippingRegion.encode = function encode(message, writer) {
                ...
                if (message.orderPriceModifierIds != null && message.orderPriceModifierIds.length)
                    for (var i = 0; i < message.orderPriceModifierIds.length; ++i)
                        $root.market.mass.ObjectId.encode(message.orderPriceModifierIds[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                return writer;
            };
             ...
             * @returns {$protobuf.Writer} Writer
             */
            ShippingRegion.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            ShippingRegion.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.ShippingRegion();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                    ...
                    case 5: {
                            if (!(message.orderPriceModifierIds && message.orderPriceModifierIds.length))
                                message.orderPriceModifierIds = [];
                            message.orderPriceModifierIds.push($root.market.mass.ObjectId.decode(reader, reader.uint32()));
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            ShippingRegion.verify = function verify(message) {
                ...
                if (message.orderPriceModifierIds != null && message.hasOwnProperty("orderPriceModifierIds")) {
                    if (!Array.isArray(message.orderPriceModifierIds))
                        return "orderPriceModifierIds: array expected";
                    for (var i = 0; i < message.orderPriceModifierIds.length; ++i) {
                        var error = $root.market.mass.ObjectId.verify(message.orderPriceModifierIds[i]);
                        if (error)
                            return "orderPriceModifierIds." + error;
                    }
                }
                return null;
            };
            ...
            ShippingRegion.fromObject = function fromObject(object) {
                ...
                if (object.orderPriceModifierIds) {
                    if (!Array.isArray(object.orderPriceModifierIds))
                        throw TypeError(".market.mass.ShippingRegion.orderPriceModifierIds: array expected");
                    message.orderPriceModifierIds = [];
                    for (var i = 0; i < object.orderPriceModifierIds.length; ++i) {
                        if (typeof object.orderPriceModifierIds[i] !== "object")
                            throw TypeError(".market.mass.ShippingRegion.orderPriceModifierIds: object expected");
                        message.orderPriceModifierIds[i] = $root.market.mass.ObjectId.fromObject(object.orderPriceModifierIds[i]);
                    }
                }
                return message;
            };
            ...
            ShippingRegion.toObject = function toObject(message, options) {
                ...
                if (message.orderPriceModifierIds && message.orderPriceModifierIds.length) {
                    object.orderPriceModifierIds = [];
                    for (var j = 0; j < message.orderPriceModifierIds.length; ++j)
                        object.orderPriceModifierIds[j] = $root.market.mass.ObjectId.toObject(message.orderPriceModifierIds[j], options);
                }
                return object;
            };
        ...
        mass.OrderPriceModifier = (function() {
             ...
             * @property {market.mass.IObjectId|null} [id] OrderPriceModifier id
            ...
            OrderPriceModifier.encode = function encode(message, writer) {
                ...
                if (message.id != null && Object.hasOwnProperty.call(message, "id"))
                    $root.market.mass.ObjectId.encode(message.id, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                if (message.title != null && Object.hasOwnProperty.call(message, "title"))
                    writer.uint32(/* id 2, wireType 2 =*/18).string(message.title);
                if (message.percentage != null && Object.hasOwnProperty.call(message, "percentage"))
                    $root.market.mass.Uint256.encode(message.percentage, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                if (message.absolute != null && Object.hasOwnProperty.call(message, "absolute"))
                    $root.market.mass.PlusMinus.encode(message.absolute, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                return writer;
            };
             ...
             * @returns {$protobuf.Writer} Writer
             */
            OrderPriceModifier.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            OrderPriceModifier.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.OrderPriceModifier();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                            message.id = $root.market.mass.ObjectId.decode(reader, reader.uint32());
                            break;
                        }
                    case 2: {
                    ...
                    case 3: {
                            message.percentage = $root.market.mass.Uint256.decode(reader, reader.uint32());
                            break;
                        }
                    case 4: {
                            message.absolute = $root.market.mass.PlusMinus.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            OrderPriceModifier.fromObject = function fromObject(object) {
                ...
                if (object.id != null) {
                    if (typeof object.id !== "object")
                        throw TypeError(".market.mass.OrderPriceModifier.id: object expected");
                ...
                if (object.percentage != null) {
                    if (typeof object.percentage !== "object")
                        throw TypeError(".market.mass.OrderPriceModifier.percentage: object expected");
                    message.percentage = $root.market.mass.Uint256.fromObject(object.percentage);
                }
                if (object.absolute != null) {
                    if (typeof object.absolute !== "object")
                        throw TypeError(".market.mass.OrderPriceModifier.absolute: object expected");
                    message.absolute = $root.market.mass.PlusMinus.fromObject(object.absolute);
                }
                return message;
            };
            ...
            OrderPriceModifier.toObject = function toObject(message, options) {
                ...
                if (message.percentage != null && message.hasOwnProperty("percentage")) {
                    object.percentage = $root.market.mass.Uint256.toObject(message.percentage, options);
                    if (options.oneofs)
                        object.modification = "percentage";
                }
                if (message.absolute != null && message.hasOwnProperty("absolute")) {
                    object.absolute = $root.market.mass.PlusMinus.toObject(message.absolute, options);
                    if (options.oneofs)
        ...
        mass.PlusMinus = (function() {
            ...
            PlusMinus.encode = function encode(message, writer) {
                if (!writer)
                    writer = $Writer.create();
                if (message.plusSign != null && Object.hasOwnProperty.call(message, "plusSign"))
                    writer.uint32(/* id 1, wireType 0 =*/8).bool(message.plusSign);
                if (message.diff != null && Object.hasOwnProperty.call(message, "diff"))
                    $root.market.mass.Uint256.encode(message.diff, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                return writer;
            };
            ...
            PlusMinus.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.PlusMinus();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                    ...
                    case 2: {
                            message.diff = $root.market.mass.Uint256.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            PlusMinus.toObject = function toObject(message, options) {
                ...
                if (message.diff != null && message.hasOwnProperty("diff"))
                    object.diff = $root.market.mass.Uint256.toObject(message.diff, options);
                return object;
            };
        ...
        mass.ListingVariation = (function() {
            ...
            ListingVariation.encode = function encode(message, writer) {
                ...
                if (message.diff != null && Object.hasOwnProperty.call(message, "diff"))
                    $root.market.mass.PlusMinus.encode(message.diff, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                return writer;
            };
            ...
            ListingVariation.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 3: {
                            message.diff = $root.market.mass.PlusMinus.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            ListingVariation.fromObject = function fromObject(object) {
                ...
                if (object.id != null) {
                    if (typeof object.id !== "object")
                        throw TypeError(".market.mass.ListingVariation.id: object expected");
                    message.id = $root.market.mass.ObjectId.fromObject(object.id);
                }
                ...
                if (object.diff != null) {
                    if (typeof object.diff !== "object")
                        throw TypeError(".market.mass.ListingVariation.diff: object expected");
            ...
            ListingVariation.toObject = function toObject(message, options) {
                ...
                if (message.diff != null && message.hasOwnProperty("diff"))
                    object.diff = $root.market.mass.PlusMinus.toObject(message.diff, options);
                return object;
            };
        ...
        mass.ListingStockStatus = (function() {
            ...
            ListingStockStatus.encode = function encode(message, writer) {
                ...
                if (message.variationIds != null && message.variationIds.length)
                    for (var i = 0; i < message.variationIds.length; ++i)
                        $root.market.mass.ObjectId.encode(message.variationIds[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            ...
            ListingStockStatus.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 1: {
                            ...
                            message.variationIds.push($root.market.mass.ObjectId.decode(reader, reader.uint32()));
                            break;
                        }
                    case 2: {
            ...
            ListingStockStatus.verify = function verify(message) {
                ...
                if (message.variationIds != null && message.hasOwnProperty("variationIds")) {
                    ...
                    for (var i = 0; i < message.variationIds.length; ++i) {
                        var error = $root.market.mass.ObjectId.verify(message.variationIds[i]);
                        if (error)
                ...
                if (object.variationIds) {
                    ...
                    for (var i = 0; i < object.variationIds.length; ++i) {
                        if (typeof object.variationIds[i] !== "object")
                            throw TypeError(".market.mass.ListingStockStatus.variationIds: object expected");
                        message.variationIds[i] = $root.market.mass.ObjectId.fromObject(object.variationIds[i]);
                    }
                }
            ...
            ListingStockStatus.toObject = function toObject(message, options) {
                ...
                if (message.variationIds && message.variationIds.length) {
                    ...
                    for (var j = 0; j < message.variationIds.length; ++j)
                        object.variationIds[j] = $root.market.mass.ObjectId.toObject(message.variationIds[j], options);
                }
                if (message.inStock != null && message.hasOwnProperty("inStock")) {
        ...
        mass.PaymentDetails = (function() {
            ...
            PaymentDetails.encode = function encode(message, writer) {
                ...
                if (message.shippingRegion != null && Object.hasOwnProperty.call(message, "shippingRegion"))
                    $root.market.mass.ShippingRegion.encode(message.shippingRegion, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                return writer;
            };
            ...
            PaymentDetails.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 6: {
                            message.shippingRegion = $root.market.mass.ShippingRegion.decode(reader, reader.uint32());
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            PaymentDetails.verify = function verify(message) {
                ...
                if (message.shippingRegion != null && message.hasOwnProperty("shippingRegion")) {
                    var error = $root.market.mass.ShippingRegion.verify(message.shippingRegion);
                    if (error)
            ...
            PaymentDetails.fromObject = function fromObject(object) {
                ...
                if (object.shippingRegion != null) {
                    if (typeof object.shippingRegion !== "object")
                        throw TypeError(".market.mass.PaymentDetails.shippingRegion: object expected");
                    message.shippingRegion = $root.market.mass.ShippingRegion.fromObject(object.shippingRegion);
                }
                return message;
            };
            ...
            PaymentDetails.toObject = function toObject(message, options) {
                ...
                if (message.shippingRegion != null && message.hasOwnProperty("shippingRegion"))
                    object.shippingRegion = $root.market.mass.ShippingRegion.toObject(message.shippingRegion, options);
                return object;
            };
        ...
        mass.OrderTransaction = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            OrderTransaction.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            OrderTransaction.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.OrderTransaction();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            OrderTransaction.fromObject = function fromObject(object) {
                ...
                if (object.txHash != null) {
                    if (typeof object.txHash !== "object")
                        throw TypeError(".market.mass.OrderTransaction.txHash: object expected");
                    message.txHash = $root.market.mass.Hash.fromObject(object.txHash);
                }
                if (object.blockHash != null) {
                    if (typeof object.blockHash !== "object")
                        throw TypeError(".market.mass.OrderTransaction.blockHash: object expected");
        ...
        mass.OrderedItem = (function() {
            ...
            OrderedItem.encode = function encode(message, writer) {
                ...
                if (message.listingId != null && Object.hasOwnProperty.call(message, "listingId"))
                    $root.market.mass.ObjectId.encode(message.listingId, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                if (message.variationIds != null && message.variationIds.length)
                    for (var i = 0; i < message.variationIds.length; ++i)
                        $root.market.mass.ObjectId.encode(message.variationIds[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            ...
            OrderedItem.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    switch (tag >>> 3) {
                    case 1: {
                            message.listingId = $root.market.mass.ObjectId.decode(reader, reader.uint32());
                            break;
                        }
                    case 2: {
                            if (!(message.variationIds && message.variationIds.length))
            ...
            OrderedItem.fromObject = function fromObject(object) {
                ...
                if (object.listingId != null) {
                    if (typeof object.listingId !== "object")
                        throw TypeError(".market.mass.OrderedItem.listingId: object expected");
                    message.listingId = $root.market.mass.ObjectId.fromObject(object.listingId);
                }
                if (object.variationIds) {
                    if (!Array.isArray(object.variationIds))
                    ...
                    for (var i = 0; i < object.variationIds.length; ++i) {
                        if (typeof object.variationIds[i] !== "object")
                            throw TypeError(".market.mass.OrderedItem.variationIds: object expected");
                        message.variationIds[i] = $root.market.mass.ObjectId.fromObject(object.variationIds[i]);
                    }
                }
            ...
            OrderedItem.toObject = function toObject(message, options) {
                ...
                if (message.listingId != null && message.hasOwnProperty("listingId"))
                    object.listingId = $root.market.mass.ObjectId.toObject(message.listingId, options);
                if (message.variationIds && message.variationIds.length) {
                    object.variationIds = [];
                    for (var j = 0; j < message.variationIds.length; ++j)
                        object.variationIds[j] = $root.market.mass.ObjectId.toObject(message.variationIds[j], options);
        ...
        mass.Envelope = (function() {
            ...
            Object.defineProperty(Envelope.prototype, "message", {
                get: $util.oneOfGetter($oneOfFields = ["response", "eventWriteRequest", "subscriptionRequest", "subscriptionCancelRequest", "subscriptionPushRequest", "syncStatusRequest", "pingRequest", "getBlobUploadUrlRequest", "authRequest", "challengeSolutionRequest"]),
                set: $util.oneOfSetter($oneOfFields)
            });
            ...
            Envelope.verify = function verify(message) {
                ...
                if (message.subscriptionCancelRequest != null && message.hasOwnProperty("subscriptionCancelRequest")) {
                    ...
                    properties.message = 1;
                    {
                        var error = $root.market.mass.SubscriptionCancelRequest.verify(message.subscriptionCancelRequest);
                        if (error)
        ...
        mass.SubscriptionPushRequest = (function() {
            ...
            SubscriptionPushRequest.encode = function encode(message, writer) {
                ...
                if (message.events != null && message.events.length)
                    for (var i = 0; i < message.events.length; ++i)
                        $root.market.mass.SubscriptionPushRequest.SequencedEvent.encode(message.events[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                return writer;
            };
                ...
                while (reader.pos < end) {
                    ...
                    case 2: {
                            if (!(message.events && message.events.length))
                                message.events = [];
                            message.events.push($root.market.mass.SubscriptionPushRequest.SequencedEvent.decode(reader, reader.uint32()));
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            SubscriptionPushRequest.verify = function verify(message) {
                ...
                if (message.events != null && message.hasOwnProperty("events")) {
                    ...
                    for (var i = 0; i < message.events.length; ++i) {
                        var error = $root.market.mass.SubscriptionPushRequest.SequencedEvent.verify(message.events[i]);
                        if (error)
                            return "events." + error;
                    }
                }
            ...
            SubscriptionPushRequest.fromObject = function fromObject(object) {
                ...
                if (object.events) {
                    ...
                    for (var i = 0; i < object.events.length; ++i) {
                        ...
                        message.events[i] = $root.market.mass.SubscriptionPushRequest.SequencedEvent.fromObject(object.events[i]);
                    }
                }
                return message;
            };
            ...
            SubscriptionPushRequest.toObject = function toObject(message, options) {
                ...
                if (message.events && message.events.length) {
                    ...
                    for (var j = 0; j < message.events.length; ++j)
                        object.events[j] = $root.market.mass.SubscriptionPushRequest.SequencedEvent.toObject(message.events[j], options);
                }
                return object;
            };
            ...
            SubscriptionPushRequest.SequencedEvent = (function() {
                 ...
                 * @instance
                 */
                SequencedEvent.prototype.seqNo = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
                ...
                SequencedEvent.encode = function encode(message, writer) {
                    ...
                    if (message.event != null && Object.hasOwnProperty.call(message, "event"))
                        $root.market.mass.SignedEvent.encode(message.event, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                 ...
                 * @returns {$protobuf.Writer} Writer
                 */
                SequencedEvent.encodeDelimited = function encodeDelimited(message, writer) {
                    return this.encode(message, writer).ldelim();
                };
                ...
                SequencedEvent.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.SubscriptionPushRequest.SequencedEvent();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                                message.event = $root.market.mass.SignedEvent.decode(reader, reader.uint32());
                                break;
                            }
                        case 2: {
                ...
                SequencedEvent.fromObject = function fromObject(object) {
                    if (object instanceof $root.market.mass.SubscriptionPushRequest.SequencedEvent)
                        return object;
                    var message = new $root.market.mass.SubscriptionPushRequest.SequencedEvent();
                    if (object.event != null) {
                        if (typeof object.event !== "object")
                            throw TypeError(".market.mass.SubscriptionPushRequest.SequencedEvent.event: object expected");
                        message.event = $root.market.mass.SignedEvent.fromObject(object.event);
                    }
                ...
                SequencedEvent.toObject = function toObject(message, options) {
                    ...
                    if (message.event != null && message.hasOwnProperty("event"))
                        object.event = $root.market.mass.SignedEvent.toObject(message.event, options);
                    if (message.seqNo != null && message.hasOwnProperty("seqNo"))
                ...
                SequencedEvent.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/market.mass.SubscriptionPushRequest.SequencedEvent";
                };
        ...
        mass.SubscriptionCancelRequest = (function() {
            ...
            SubscriptionCancelRequest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.SubscriptionCancelRequest();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.Manifest = (function() {
             ...
             * @property {Array.<market.mass.IOrderPriceModifier>|null} [orderPriceModifiers] Manifest orderPriceModifiers
             */
            ...
            /**
             * Manifest orderPriceModifiers.
             * @member {Array.<market.mass.IOrderPriceModifier>} orderPriceModifiers
             * @memberof market.mass.Manifest
             * @instance
             */
            Manifest.prototype.orderPriceModifiers = $util.emptyArray;
            ...
            Manifest.encode = function encode(message, writer) {
                ...
                if (message.pricingCurrency != null && Object.hasOwnProperty.call(message, "pricingCurrency"))
                    $root.market.mass.ShopCurrency.encode(message.pricingCurrency, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                if (message.shippingRegions != null && message.shippingRegions.length)
                    for (var i = 0; i < message.shippingRegions.length; ++i)
                        $root.market.mass.ShippingRegion.encode(message.shippingRegions[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                if (message.orderPriceModifiers != null && message.orderPriceModifiers.length)
                    for (var i = 0; i < message.orderPriceModifiers.length; ++i)
                        $root.market.mass.OrderPriceModifier.encode(message.orderPriceModifiers[i], writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                return writer;
            };
            ...
            Manifest.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 4: {
                            message.pricingCurrency = $root.market.mass.ShopCurrency.decode(reader, reader.uint32());
                            break;
                        }
                    case 5: {
                            if (!(message.shippingRegions && message.shippingRegions.length))
                                message.shippingRegions = [];
                            message.shippingRegions.push($root.market.mass.ShippingRegion.decode(reader, reader.uint32()));
                            break;
                        }
                    case 6: {
                            if (!(message.orderPriceModifiers && message.orderPriceModifiers.length))
                                message.orderPriceModifiers = [];
                            message.orderPriceModifiers.push($root.market.mass.OrderPriceModifier.decode(reader, reader.uint32()));
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            Manifest.verify = function verify(message) {
                ...
                if (message.pricingCurrency != null && message.hasOwnProperty("pricingCurrency")) {
                    var error = $root.market.mass.ShopCurrency.verify(message.pricingCurrency);
                    if (error)
                        return "pricingCurrency." + error;
                }
                if (message.shippingRegions != null && message.hasOwnProperty("shippingRegions")) {
                    if (!Array.isArray(message.shippingRegions))
                        return "shippingRegions: array expected";
                    for (var i = 0; i < message.shippingRegions.length; ++i) {
                        var error = $root.market.mass.ShippingRegion.verify(message.shippingRegions[i]);
                        if (error)
                            return "shippingRegions." + error;
                    }
                }
                if (message.orderPriceModifiers != null && message.hasOwnProperty("orderPriceModifiers")) {
                    if (!Array.isArray(message.orderPriceModifiers))
                        return "orderPriceModifiers: array expected";
                    for (var i = 0; i < message.orderPriceModifiers.length; ++i) {
                        var error = $root.market.mass.OrderPriceModifier.verify(message.orderPriceModifiers[i]);
                        if (error)
            ...
            Manifest.fromObject = function fromObject(object) {
                ...
                if (object.pricingCurrency != null) {
                    if (typeof object.pricingCurrency !== "object")
                        throw TypeError(".market.mass.Manifest.pricingCurrency: object expected");
                    message.pricingCurrency = $root.market.mass.ShopCurrency.fromObject(object.pricingCurrency);
                }
                if (object.shippingRegions) {
                    if (!Array.isArray(object.shippingRegions))
                        throw TypeError(".market.mass.Manifest.shippingRegions: array expected");
                    message.shippingRegions = [];
                    for (var i = 0; i < object.shippingRegions.length; ++i) {
                        if (typeof object.shippingRegions[i] !== "object")
                            throw TypeError(".market.mass.Manifest.shippingRegions: object expected");
                        message.shippingRegions[i] = $root.market.mass.ShippingRegion.fromObject(object.shippingRegions[i]);
                    }
                }
                if (object.orderPriceModifiers) {
                    if (!Array.isArray(object.orderPriceModifiers))
                        throw TypeError(".market.mass.Manifest.orderPriceModifiers: array expected");
                    message.orderPriceModifiers = [];
                    for (var i = 0; i < object.orderPriceModifiers.length; ++i) {
                        if (typeof object.orderPriceModifiers[i] !== "object")
                            throw TypeError(".market.mass.Manifest.orderPriceModifiers: object expected");
                        message.orderPriceModifiers[i] = $root.market.mass.OrderPriceModifier.fromObject(object.orderPriceModifiers[i]);
                    }
                }
                return message;
            };
            ...
            Manifest.toObject = function toObject(message, options) {
                ...
                if (message.pricingCurrency != null && message.hasOwnProperty("pricingCurrency"))
                    object.pricingCurrency = $root.market.mass.ShopCurrency.toObject(message.pricingCurrency, options);
                if (message.shippingRegions && message.shippingRegions.length) {
                    object.shippingRegions = [];
                    for (var j = 0; j < message.shippingRegions.length; ++j)
                        object.shippingRegions[j] = $root.market.mass.ShippingRegion.toObject(message.shippingRegions[j], options);
                }
                if (message.orderPriceModifiers && message.orderPriceModifiers.length) {
                    object.orderPriceModifiers = [];
                    for (var j = 0; j < message.orderPriceModifiers.length; ++j)
                        object.orderPriceModifiers[j] = $root.market.mass.OrderPriceModifier.toObject(message.orderPriceModifiers[j], options);
                }
                return object;
            };
        ...
        mass.UpdateManifest = (function() {
             ...
             * @property {Array.<market.mass.IOrderPriceModifier>|null} [addOrderPriceModifiers] UpdateManifest addOrderPriceModifiers
             * @property {Array.<market.mass.IObjectId>|null} [removeOrderPriceModifierIds] UpdateManifest removeOrderPriceModifierIds
            ...
            function UpdateManifest(properties) {
                ...
                this.addOrderPriceModifiers = [];
                this.removeOrderPriceModifierIds = [];
            ...
            /**
             * UpdateManifest addOrderPriceModifiers.
             * @member {Array.<market.mass.IOrderPriceModifier>} addOrderPriceModifiers
             * @memberof market.mass.UpdateManifest
             * @instance
             */
            UpdateManifest.prototype.addOrderPriceModifiers = $util.emptyArray;

            /**
             * UpdateManifest removeOrderPriceModifierIds.
             * @member {Array.<market.mass.IObjectId>} removeOrderPriceModifierIds
             * @memberof market.mass.UpdateManifest
             * @instance
             */
            UpdateManifest.prototype.removeOrderPriceModifierIds = $util.emptyArray;
             ...
             * @member {"setPricingCurrency"|undefined} _setPricingCurrency
             * @memberof market.mass.UpdateManifest
             * @instance
             */
            ...
            UpdateManifest.encode = function encode(message, writer) {
                ...
                if (message.setPricingCurrency != null && Object.hasOwnProperty.call(message, "setPricingCurrency"))
                    $root.market.mass.ShopCurrency.encode(message.setPricingCurrency, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                if (message.addShippingRegions != null && message.addShippingRegions.length)
                    for (var i = 0; i < message.addShippingRegions.length; ++i)
                        $root.market.mass.ShippingRegion.encode(message.addShippingRegions[i], writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
                if (message.removeShippingRegions != null && message.removeShippingRegions.length)
                    for (var i = 0; i < message.removeShippingRegions.length; ++i)
                        writer.uint32(/* id 8, wireType 2 =*/66).string(message.removeShippingRegions[i]);
                if (message.addOrderPriceModifiers != null && message.addOrderPriceModifiers.length)
                    for (var i = 0; i < message.addOrderPriceModifiers.length; ++i)
                        $root.market.mass.OrderPriceModifier.encode(message.addOrderPriceModifiers[i], writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
                if (message.removeOrderPriceModifierIds != null && message.removeOrderPriceModifierIds.length)
                    for (var i = 0; i < message.removeOrderPriceModifierIds.length; ++i)
                        $root.market.mass.ObjectId.encode(message.removeOrderPriceModifierIds[i], writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
                return writer;
            };
            ...
            UpdateManifest.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 6: {
                            message.setPricingCurrency = $root.market.mass.ShopCurrency.decode(reader, reader.uint32());
                            break;
                        }
                    case 9: {
                            if (!(message.addOrderPriceModifiers && message.addOrderPriceModifiers.length))
                                message.addOrderPriceModifiers = [];
                            message.addOrderPriceModifiers.push($root.market.mass.OrderPriceModifier.decode(reader, reader.uint32()));
                            break;
                        }
                    case 10: {
                            if (!(message.removeOrderPriceModifierIds && message.removeOrderPriceModifierIds.length))
                                message.removeOrderPriceModifierIds = [];
                            message.removeOrderPriceModifierIds.push($root.market.mass.ObjectId.decode(reader, reader.uint32()));
                            break;
                        }
                    case 7: {
                            if (!(message.addShippingRegions && message.addShippingRegions.length))
                                message.addShippingRegions = [];
                            message.addShippingRegions.push($root.market.mass.ShippingRegion.decode(reader, reader.uint32()));
                            break;
                        }
                    case 8: {
                            if (!(message.removeShippingRegions && message.removeShippingRegions.length))
            ...
            UpdateManifest.verify = function verify(message) {
                ...
                if (message.setPricingCurrency != null && message.hasOwnProperty("setPricingCurrency")) {
                    properties._setPricingCurrency = 1;
                    {
                        var error = $root.market.mass.ShopCurrency.verify(message.setPricingCurrency);
                        if (error)
                            return "setPricingCurrency." + error;
                    }
                }
                if (message.addOrderPriceModifiers != null && message.hasOwnProperty("addOrderPriceModifiers")) {
                    if (!Array.isArray(message.addOrderPriceModifiers))
                        return "addOrderPriceModifiers: array expected";
                    for (var i = 0; i < message.addOrderPriceModifiers.length; ++i) {
                        var error = $root.market.mass.OrderPriceModifier.verify(message.addOrderPriceModifiers[i]);
                        if (error)
                            return "addOrderPriceModifiers." + error;
                    }
                }
                if (message.removeOrderPriceModifierIds != null && message.hasOwnProperty("removeOrderPriceModifierIds")) {
                    if (!Array.isArray(message.removeOrderPriceModifierIds))
                        return "removeOrderPriceModifierIds: array expected";
                    for (var i = 0; i < message.removeOrderPriceModifierIds.length; ++i) {
                        var error = $root.market.mass.ObjectId.verify(message.removeOrderPriceModifierIds[i]);
                        if (error)
                            return "removeOrderPriceModifierIds." + error;
                    }
                }
                if (message.addShippingRegions != null && message.hasOwnProperty("addShippingRegions")) {
                    if (!Array.isArray(message.addShippingRegions))
                        return "addShippingRegions: array expected";
                    for (var i = 0; i < message.addShippingRegions.length; ++i) {
                        var error = $root.market.mass.ShippingRegion.verify(message.addShippingRegions[i]);
                        if (error)
                            return "addShippingRegions." + error;
                    }
                }
                if (message.removeShippingRegions != null && message.hasOwnProperty("removeShippingRegions")) {
            ...
            UpdateManifest.fromObject = function fromObject(object) {
                ...
                if (object.setPricingCurrency != null) {
                    if (typeof object.setPricingCurrency !== "object")
                        throw TypeError(".market.mass.UpdateManifest.setPricingCurrency: object expected");
                    message.setPricingCurrency = $root.market.mass.ShopCurrency.fromObject(object.setPricingCurrency);
                }
                if (object.addOrderPriceModifiers) {
                    if (!Array.isArray(object.addOrderPriceModifiers))
                        throw TypeError(".market.mass.UpdateManifest.addOrderPriceModifiers: array expected");
                    message.addOrderPriceModifiers = [];
                    for (var i = 0; i < object.addOrderPriceModifiers.length; ++i) {
                        if (typeof object.addOrderPriceModifiers[i] !== "object")
                            throw TypeError(".market.mass.UpdateManifest.addOrderPriceModifiers: object expected");
                        message.addOrderPriceModifiers[i] = $root.market.mass.OrderPriceModifier.fromObject(object.addOrderPriceModifiers[i]);
                    }
                }
                if (object.removeOrderPriceModifierIds) {
                    if (!Array.isArray(object.removeOrderPriceModifierIds))
                        throw TypeError(".market.mass.UpdateManifest.removeOrderPriceModifierIds: array expected");
                    message.removeOrderPriceModifierIds = [];
                    for (var i = 0; i < object.removeOrderPriceModifierIds.length; ++i) {
                        if (typeof object.removeOrderPriceModifierIds[i] !== "object")
                            throw TypeError(".market.mass.UpdateManifest.removeOrderPriceModifierIds: object expected");
                        message.removeOrderPriceModifierIds[i] = $root.market.mass.ObjectId.fromObject(object.removeOrderPriceModifierIds[i]);
                    }
                }
                if (object.addShippingRegions) {
                    if (!Array.isArray(object.addShippingRegions))
                        throw TypeError(".market.mass.UpdateManifest.addShippingRegions: array expected");
                    message.addShippingRegions = [];
                    for (var i = 0; i < object.addShippingRegions.length; ++i) {
                        if (typeof object.addShippingRegions[i] !== "object")
                            throw TypeError(".market.mass.UpdateManifest.addShippingRegions: object expected");
                        message.addShippingRegions[i] = $root.market.mass.ShippingRegion.fromObject(object.addShippingRegions[i]);
                    }
                }
                if (object.removeShippingRegions) {
                    if (!Array.isArray(object.removeShippingRegions))
                        throw TypeError(".market.mass.UpdateManifest.removeShippingRegions: array expected");
                    message.removeShippingRegions = [];
                    for (var i = 0; i < object.removeShippingRegions.length; ++i)
                        message.removeShippingRegions[i] = String(object.removeShippingRegions[i]);
                }
                return message;
            };
            ...
            UpdateManifest.toObject = function toObject(message, options) {
                ...
                if (options.arrays || options.defaults) {
                    ...
                    object.addOrderPriceModifiers = [];
                    object.removeOrderPriceModifierIds = [];
                }
                if (message.addPayee != null && message.hasOwnProperty("addPayee")) {
                ...
                if (message.setPricingCurrency != null && message.hasOwnProperty("setPricingCurrency")) {
                    object.setPricingCurrency = $root.market.mass.ShopCurrency.toObject(message.setPricingCurrency, options);
                    if (options.oneofs)
                ...
                if (message.addShippingRegions && message.addShippingRegions.length) {
                    ...
                    for (var j = 0; j < message.addShippingRegions.length; ++j)
                        object.addShippingRegions[j] = $root.market.mass.ShippingRegion.toObject(message.addShippingRegions[j], options);
                }
                if (message.removeShippingRegions && message.removeShippingRegions.length) {
                    object.removeShippingRegions = [];
                ...
                if (message.addOrderPriceModifiers && message.addOrderPriceModifiers.length) {
                    object.addOrderPriceModifiers = [];
                    for (var j = 0; j < message.addOrderPriceModifiers.length; ++j)
                        object.addOrderPriceModifiers[j] = $root.market.mass.OrderPriceModifier.toObject(message.addOrderPriceModifiers[j], options);
                }
                if (message.removeOrderPriceModifierIds && message.removeOrderPriceModifierIds.length) {
                    object.removeOrderPriceModifierIds = [];
                    for (var j = 0; j < message.removeOrderPriceModifierIds.length; ++j)
                        object.removeOrderPriceModifierIds[j] = $root.market.mass.ObjectId.toObject(message.removeOrderPriceModifierIds[j], options);
                }
                return object;
            };
        ...
        mass.Listing = (function() {
            ...
            Listing.encode = function encode(message, writer) {
                ...
                if (message.price != null && Object.hasOwnProperty.call(message, "price"))
                    $root.market.mass.Uint256.encode(message.price, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                if (message.metadata != null && Object.hasOwnProperty.call(message, "metadata"))
                    $root.market.mass.ListingMetadata.encode(message.metadata, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            ...
            Listing.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 2: {
                            message.price = $root.market.mass.Uint256.decode(reader, reader.uint32());
                            break;
                        }
                    case 3: {
                            message.metadata = $root.market.mass.ListingMetadata.decode(reader, reader.uint32());
                            break;
                        }
                    case 4: {
            ...
            Listing.verify = function verify(message) {
                ...
                if (message.metadata != null && message.hasOwnProperty("metadata")) {
                    var error = $root.market.mass.ListingMetadata.verify(message.metadata);
                    if (error)
            ...
            Listing.fromObject = function fromObject(object) {
                ...
                if (object.metadata != null) {
                    ...
                    message.metadata = $root.market.mass.ListingMetadata.fromObject(object.metadata);
                }
            ...
            Listing.toObject = function toObject(message, options) {
                ...
                if (message.id != null && message.hasOwnProperty("id"))
                    object.id = $root.market.mass.ObjectId.toObject(message.id, options);
                if (message.price != null && message.hasOwnProperty("price"))
                    object.price = $root.market.mass.Uint256.toObject(message.price, options);
                if (message.metadata != null && message.hasOwnProperty("metadata"))
                    object.metadata = $root.market.mass.ListingMetadata.toObject(message.metadata, options);
                if (message.viewState != null && message.hasOwnProperty("viewState"))
        ...
        mass.UpdateListing = (function() {
            ...
            UpdateListing.encode = function encode(message, writer) {
                ...
                if (message.addOptions != null && message.addOptions.length)
                    for (var i = 0; i < message.addOptions.length; ++i)
                        $root.market.mass.ListingOption.encode(message.addOptions[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                if (message.removeOptionIds != null && message.removeOptionIds.length)
                    for (var i = 0; i < message.removeOptionIds.length; ++i)
                        $root.market.mass.ObjectId.encode(message.removeOptionIds[i], writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                if (message.addVariations != null && message.addVariations.length)
                    for (var i = 0; i < message.addVariations.length; ++i)
                        $root.market.mass.UpdateListing.AddVariation.encode(message.addVariations[i], writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
                if (message.removeVariationIds != null && message.removeVariationIds.length)
                    for (var i = 0; i < message.removeVariationIds.length; ++i)
                        $root.market.mass.ObjectId.encode(message.removeVariationIds[i], writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
                if (message.stockUpdates != null && message.stockUpdates.length)
                    for (var i = 0; i < message.stockUpdates.length; ++i)
                        $root.market.mass.ListingStockStatus.encode(message.stockUpdates[i], writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
                return writer;
            };
            ...
            UpdateListing.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 6: {
                            ...
                            message.removeOptionIds.push($root.market.mass.ObjectId.decode(reader, reader.uint32()));
                            break;
                        }
                    case 7: {
                    ...
                    case 8: {
                            ...
                            message.removeVariationIds.push($root.market.mass.ObjectId.decode(reader, reader.uint32()));
                            break;
                        }
                    case 9: {
            ...
            UpdateListing.verify = function verify(message) {
                ...
                if (message.removeOptionIds != null && message.hasOwnProperty("removeOptionIds")) {
                    if (!Array.isArray(message.removeOptionIds))
                        return "removeOptionIds: array expected";
                    for (var i = 0; i < message.removeOptionIds.length; ++i) {
                        var error = $root.market.mass.ObjectId.verify(message.removeOptionIds[i]);
                        if (error)
                ...
                if (message.removeVariationIds != null && message.hasOwnProperty("removeVariationIds")) {
                    if (!Array.isArray(message.removeVariationIds))
                        return "removeVariationIds: array expected";
                    for (var i = 0; i < message.removeVariationIds.length; ++i) {
                        var error = $root.market.mass.ObjectId.verify(message.removeVariationIds[i]);
                        if (error)
            ...
            UpdateListing.fromObject = function fromObject(object) {
                ...
                if (object.price != null) {
                    if (typeof object.price !== "object")
                        throw TypeError(".market.mass.UpdateListing.price: object expected");
                    message.price = $root.market.mass.Uint256.fromObject(object.price);
                }
                if (object.metadata != null) {
                    if (typeof object.metadata !== "object")
                        throw TypeError(".market.mass.UpdateListing.metadata: object expected");
                    message.metadata = $root.market.mass.ListingMetadata.fromObject(object.metadata);
                }
                switch (object.viewState) {
                default:
                ...
                if (object.removeOptionIds) {
                    if (!Array.isArray(object.removeOptionIds))
                        throw TypeError(".market.mass.UpdateListing.removeOptionIds: array expected");
                    message.removeOptionIds = [];
                    for (var i = 0; i < object.removeOptionIds.length; ++i) {
                        if (typeof object.removeOptionIds[i] !== "object")
                            throw TypeError(".market.mass.UpdateListing.removeOptionIds: object expected");
                        message.removeOptionIds[i] = $root.market.mass.ObjectId.fromObject(object.removeOptionIds[i]);
                    }
                }
                ...
                if (object.removeVariationIds) {
                    if (!Array.isArray(object.removeVariationIds))
                        throw TypeError(".market.mass.UpdateListing.removeVariationIds: array expected");
                    message.removeVariationIds = [];
                    for (var i = 0; i < object.removeVariationIds.length; ++i) {
                        if (typeof object.removeVariationIds[i] !== "object")
                            throw TypeError(".market.mass.UpdateListing.removeVariationIds: object expected");
                        message.removeVariationIds[i] = $root.market.mass.ObjectId.fromObject(object.removeVariationIds[i]);
                    }
                }
            ...
            UpdateListing.toObject = function toObject(message, options) {
                ...
                if (message.removeOptionIds && message.removeOptionIds.length) {
                    ...
                    for (var j = 0; j < message.removeOptionIds.length; ++j)
                        object.removeOptionIds[j] = $root.market.mass.ObjectId.toObject(message.removeOptionIds[j], options);
                }
                if (message.addVariations && message.addVariations.length) {
                    object.addVariations = [];
                ...
                if (message.removeVariationIds && message.removeVariationIds.length) {
                    ...
                    for (var j = 0; j < message.removeVariationIds.length; ++j)
                        object.removeVariationIds[j] = $root.market.mass.ObjectId.toObject(message.removeVariationIds[j], options);
                }
                if (message.stockUpdates && message.stockUpdates.length) {
                    object.stockUpdates = [];
            ...
            UpdateListing.AddVariation = (function() {
                ...
                AddVariation.encode = function encode(message, writer) {
                    ...
                    if (message.optionId != null && Object.hasOwnProperty.call(message, "optionId"))
                        $root.market.mass.ObjectId.encode(message.optionId, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                ...
                AddVariation.decode = function decode(reader, length) {
                    ...
                    while (reader.pos < end) {
                        ...
                        switch (tag >>> 3) {
                        case 1: {
                                message.optionId = $root.market.mass.ObjectId.decode(reader, reader.uint32());
                                break;
                            }
                        case 2: {
                ...
                AddVariation.fromObject = function fromObject(object) {
                    ...
                    if (object.optionId != null) {
                        if (typeof object.optionId !== "object")
                            throw TypeError(".market.mass.UpdateListing.AddVariation.optionId: object expected");
                        message.optionId = $root.market.mass.ObjectId.fromObject(object.optionId);
                    }
                ...
                AddVariation.toObject = function toObject(message, options) {
                    ...
                    if (message.optionId != null && message.hasOwnProperty("optionId"))
                        object.optionId = $root.market.mass.ObjectId.toObject(message.optionId, options);
                    if (message.variation != null && message.hasOwnProperty("variation"))
        ...
        mass.ChangeInventory = (function() {
            ...
            ChangeInventory.fromObject = function fromObject(object) {
                ...
                if (object.variationIds) {
                    ...
                    for (var i = 0; i < object.variationIds.length; ++i) {
                        if (typeof object.variationIds[i] !== "object")
                            throw TypeError(".market.mass.ChangeInventory.variationIds: object expected");
                        message.variationIds[i] = $root.market.mass.ObjectId.fromObject(object.variationIds[i]);
                    }
                }
                if (object.diff != null)
        ...
        mass.Tag = (function() {
            ...
            Tag.encode = function encode(message, writer) {
                ...
                if (message.listingIds != null && message.listingIds.length)
                    for (var i = 0; i < message.listingIds.length; ++i)
                        $root.market.mass.ObjectId.encode(message.listingIds[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                ...
                while (reader.pos < end) {
                    ...
                    case 3: {
                            if (!(message.listingIds && message.listingIds.length))
                                message.listingIds = [];
                            message.listingIds.push($root.market.mass.ObjectId.decode(reader, reader.uint32()));
                            break;
                        }
                    case 4: {
            ...
            Tag.verify = function verify(message) {
                ...
                if (message.listingIds != null && message.hasOwnProperty("listingIds")) {
                    ...
                    for (var i = 0; i < message.listingIds.length; ++i) {
                        var error = $root.market.mass.ObjectId.verify(message.listingIds[i]);
                        if (error)
            ...
            Tag.fromObject = function fromObject(object) {
                ...
                if (object.listingIds) {
                    ...
                    for (var i = 0; i < object.listingIds.length; ++i) {
                        ...
                        message.listingIds[i] = $root.market.mass.ObjectId.fromObject(object.listingIds[i]);
                    }
                }
            ...
            Tag.toObject = function toObject(message, options) {
                ...
                if (message.listingIds && message.listingIds.length) {
                    ...
                    for (var j = 0; j < message.listingIds.length; ++j)
                        object.listingIds[j] = $root.market.mass.ObjectId.toObject(message.listingIds[j], options);
                }
                if (message.deleted != null && message.hasOwnProperty("deleted"))
        ...
        mass.UpdateTag = (function() {
            ...
            UpdateTag.encode = function encode(message, writer) {
                ...
                if (message.addListingIds != null && message.addListingIds.length)
                    for (var i = 0; i < message.addListingIds.length; ++i)
                        $root.market.mass.ObjectId.encode(message.addListingIds[i], writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
                if (message.removeListingIds != null && message.removeListingIds.length)
                    for (var i = 0; i < message.removeListingIds.length; ++i)
                        $root.market.mass.ObjectId.encode(message.removeListingIds[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            ...
            UpdateTag.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 3: {
                            ...
                            message.addListingIds.push($root.market.mass.ObjectId.decode(reader, reader.uint32()));
                            break;
                        }
                    case 4: {
                            if (!(message.removeListingIds && message.removeListingIds.length))
                                message.removeListingIds = [];
                            message.removeListingIds.push($root.market.mass.ObjectId.decode(reader, reader.uint32()));
                            break;
                        }
                    case 5: {
            ...
            UpdateTag.verify = function verify(message) {
                ...
                if (message.addListingIds != null && message.hasOwnProperty("addListingIds")) {
                    ...
                    for (var i = 0; i < message.addListingIds.length; ++i) {
                        var error = $root.market.mass.ObjectId.verify(message.addListingIds[i]);
                        if (error)
                ...
                if (message.removeListingIds != null && message.hasOwnProperty("removeListingIds")) {
                    ...
                    for (var i = 0; i < message.removeListingIds.length; ++i) {
                        var error = $root.market.mass.ObjectId.verify(message.removeListingIds[i]);
                        if (error)
                ...
                if (object.addListingIds) {
                    ...
                    for (var i = 0; i < object.addListingIds.length; ++i) {
                        if (typeof object.addListingIds[i] !== "object")
                            throw TypeError(".market.mass.UpdateTag.addListingIds: object expected");
                        message.addListingIds[i] = $root.market.mass.ObjectId.fromObject(object.addListingIds[i]);
                    }
                }
                if (object.removeListingIds) {
                    ...
                    for (var i = 0; i < object.removeListingIds.length; ++i) {
                        if (typeof object.removeListingIds[i] !== "object")
                            throw TypeError(".market.mass.UpdateTag.removeListingIds: object expected");
                        message.removeListingIds[i] = $root.market.mass.ObjectId.fromObject(object.removeListingIds[i]);
                    }
                }
            ...
            UpdateTag.toObject = function toObject(message, options) {
                ...
                if (message.addListingIds && message.addListingIds.length) {
                    ...
                    for (var j = 0; j < message.addListingIds.length; ++j)
                        object.addListingIds[j] = $root.market.mass.ObjectId.toObject(message.addListingIds[j], options);
                }
                if (message.removeListingIds && message.removeListingIds.length) {
                    object.removeListingIds = [];
                    for (var j = 0; j < message.removeListingIds.length; ++j)
                        object.removeListingIds[j] = $root.market.mass.ObjectId.toObject(message.removeListingIds[j], options);
                }
                if (message["delete"] != null && message.hasOwnProperty("delete")) {
        ...
        mass.Order = (function() {
             ...
             * @property {string|null} [merchantNotes] Order merchantNotes
             ...
             * @property {Array.<market.mass.IOrderTransaction>|null} [wittnessedTransactions] Order wittnessedTransactions
             */
            ...
            /**
             * Order wittnessedTransactions.
             * @member {Array.<market.mass.IOrderTransaction>} wittnessedTransactions
             * @memberof market.mass.Order
             * @instance
             */
            Order.prototype.wittnessedTransactions = $util.emptyArray;
            ...
            /**
             * Order _commitedAt.
             * @member {"commitedAt"|undefined} _commitedAt
             * @memberof market.mass.Order
             * @instance
             */
             ...
             * @member {"addressUpdatedAt"|undefined} _addressUpdatedAt
             * @memberof market.mass.Order
             * @instance
             */
             ...
             * @member {"paymentDetailsCreatedAt"|undefined} _paymentDetailsCreatedAt
             * @memberof market.mass.Order
             * @instance
             */
            ...
            Order.encode = function encode(message, writer) {
                ...
                if (message.merchantNotes != null && Object.hasOwnProperty.call(message, "merchantNotes"))
                    writer.uint32(/* id 3, wireType 2 =*/26).string(message.merchantNotes);
                if (message.canceledAt != null && Object.hasOwnProperty.call(message, "canceledAt"))
                    $root.google.protobuf.Timestamp.encode(message.canceledAt, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                if (message.commitedAt != null && Object.hasOwnProperty.call(message, "commitedAt"))
                    $root.google.protobuf.Timestamp.encode(message.commitedAt, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                if (message.invoiceAddress != null && Object.hasOwnProperty.call(message, "invoiceAddress"))
                    $root.market.mass.AddressDetails.encode(message.invoiceAddress, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                if (message.shippingAddress != null && Object.hasOwnProperty.call(message, "shippingAddress"))
                    $root.market.mass.AddressDetails.encode(message.shippingAddress, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
                if (message.addressUpdatedAt != null && Object.hasOwnProperty.call(message, "addressUpdatedAt"))
                    $root.google.protobuf.Timestamp.encode(message.addressUpdatedAt, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
                if (message.chosenPayee != null && Object.hasOwnProperty.call(message, "chosenPayee"))
                    $root.market.mass.Payee.encode(message.chosenPayee, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
                if (message.chosenCurrency != null && Object.hasOwnProperty.call(message, "chosenCurrency"))
                    $root.market.mass.ShopCurrency.encode(message.chosenCurrency, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
                if (message.paymentDetails != null && Object.hasOwnProperty.call(message, "paymentDetails"))
                    $root.market.mass.PaymentDetails.encode(message.paymentDetails, writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
                if (message.paymentDetailsCreatedAt != null && Object.hasOwnProperty.call(message, "paymentDetailsCreatedAt"))
                    $root.google.protobuf.Timestamp.encode(message.paymentDetailsCreatedAt, writer.uint32(/* id 12, wireType 2 =*/98).fork()).ldelim();
                if (message.wittnessedTransactions != null && message.wittnessedTransactions.length)
                    for (var i = 0; i < message.wittnessedTransactions.length; ++i)
                        $root.market.mass.OrderTransaction.encode(message.wittnessedTransactions[i], writer.uint32(/* id 13, wireType 2 =*/106).fork()).ldelim();
                return writer;
            };
            ...
            Order.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 3: {
                            message.merchantNotes = reader.string();
                            break;
                        }
                    case 4: {
                    ...
                    case 8: {
                            message.addressUpdatedAt = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                            break;
                        }
                    case 9: {
                    ...
                    case 12: {
                            message.paymentDetailsCreatedAt = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                            break;
                        }
                    case 13: {
                            if (!(message.wittnessedTransactions && message.wittnessedTransactions.length))
                                message.wittnessedTransactions = [];
                            message.wittnessedTransactions.push($root.market.mass.OrderTransaction.decode(reader, reader.uint32()));
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            Order.verify = function verify(message) {
                ...
                if (message.merchantNotes != null && message.hasOwnProperty("merchantNotes"))
                    if (!$util.isString(message.merchantNotes))
                        return "merchantNotes: string expected";
                ...
                if (message.addressUpdatedAt != null && message.hasOwnProperty("addressUpdatedAt")) {
                    properties._addressUpdatedAt = 1;
                    {
                        var error = $root.google.protobuf.Timestamp.verify(message.addressUpdatedAt);
                        if (error)
                ...
                if (message.paymentDetailsCreatedAt != null && message.hasOwnProperty("paymentDetailsCreatedAt")) {
                    properties._paymentDetailsCreatedAt = 1;
                    {
                        var error = $root.google.protobuf.Timestamp.verify(message.paymentDetailsCreatedAt);
                        if (error)
                            return "paymentDetailsCreatedAt." + error;
                    }
                }
                if (message.wittnessedTransactions != null && message.hasOwnProperty("wittnessedTransactions")) {
                    if (!Array.isArray(message.wittnessedTransactions))
                        return "wittnessedTransactions: array expected";
                    for (var i = 0; i < message.wittnessedTransactions.length; ++i) {
                        var error = $root.market.mass.OrderTransaction.verify(message.wittnessedTransactions[i]);
                        if (error)
                            return "wittnessedTransactions." + error;
                    }
                }
                return null;
            };
            ...
            Order.fromObject = function fromObject(object) {
                ...
                if (object.merchantNotes != null)
                    message.merchantNotes = String(object.merchantNotes);
                ...
                if (object.addressUpdatedAt != null) {
                    if (typeof object.addressUpdatedAt !== "object")
                        throw TypeError(".market.mass.Order.addressUpdatedAt: object expected");
                    message.addressUpdatedAt = $root.google.protobuf.Timestamp.fromObject(object.addressUpdatedAt);
                }
                ...
                if (object.paymentDetailsCreatedAt != null) {
                    if (typeof object.paymentDetailsCreatedAt !== "object")
                        throw TypeError(".market.mass.Order.paymentDetailsCreatedAt: object expected");
                    message.paymentDetailsCreatedAt = $root.google.protobuf.Timestamp.fromObject(object.paymentDetailsCreatedAt);
                }
                if (object.wittnessedTransactions) {
                    if (!Array.isArray(object.wittnessedTransactions))
                        throw TypeError(".market.mass.Order.wittnessedTransactions: array expected");
                    message.wittnessedTransactions = [];
                    for (var i = 0; i < object.wittnessedTransactions.length; ++i) {
                        if (typeof object.wittnessedTransactions[i] !== "object")
                            throw TypeError(".market.mass.Order.wittnessedTransactions: object expected");
                        message.wittnessedTransactions[i] = $root.market.mass.OrderTransaction.fromObject(object.wittnessedTransactions[i]);
                    }
                }
                return message;
            };
            ...
            Order.toObject = function toObject(message, options) {
                ...
                if (options.arrays || options.defaults) {
                    object.items = [];
                    object.wittnessedTransactions = [];
                }
                if (options.defaults) {
                    object.id = null;
                    object.merchantNotes = "";
                }
                if (message.id != null && message.hasOwnProperty("id"))
                    object.id = $root.market.mass.ObjectId.toObject(message.id, options);
                if (message.items && message.items.length) {
                ...
                if (message.merchantNotes != null && message.hasOwnProperty("merchantNotes"))
                    object.merchantNotes = message.merchantNotes;
                if (message.canceledAt != null && message.hasOwnProperty("canceledAt")) {
                ...
                if (message.addressUpdatedAt != null && message.hasOwnProperty("addressUpdatedAt")) {
                    object.addressUpdatedAt = $root.google.protobuf.Timestamp.toObject(message.addressUpdatedAt, options);
                    if (options.oneofs)
                ...
                if (message.paymentDetailsCreatedAt != null && message.hasOwnProperty("paymentDetailsCreatedAt")) {
                    object.paymentDetailsCreatedAt = $root.google.protobuf.Timestamp.toObject(message.paymentDetailsCreatedAt, options);
                    if (options.oneofs)
                        object._paymentDetailsCreatedAt = "paymentDetailsCreatedAt";
                }
                if (message.wittnessedTransactions && message.wittnessedTransactions.length) {
                    object.wittnessedTransactions = [];
                    for (var j = 0; j < message.wittnessedTransactions.length; ++j)
                        object.wittnessedTransactions[j] = $root.market.mass.OrderTransaction.toObject(message.wittnessedTransactions[j], options);
                }
                return object;
            };
        ...
        mass.UpdateOrder = (function() {
             ...
             * @property {market.mass.IOrderTransaction|null} [addWittnessedTx] UpdateOrder addWittnessedTx
             * @property {string|null} [setMerchantNotes] UpdateOrder setMerchantNotes
             */
            ...
            /**
             * UpdateOrder addWittnessedTx.
             * @member {market.mass.IOrderTransaction|null|undefined} addWittnessedTx
             * @memberof market.mass.UpdateOrder
             * @instance
             */
            UpdateOrder.prototype.addWittnessedTx = null;

            /**
             * UpdateOrder setMerchantNotes.
             * @member {string|null|undefined} setMerchantNotes
             * @memberof market.mass.UpdateOrder
             * @instance
             */
            UpdateOrder.prototype.setMerchantNotes = null;
            ...
            /**
             * UpdateOrder action.
             * @member {"cancel"|"changeItems"|"commitItems"|"setInvoiceAddress"|"setShippingAddress"|"choosePayment"|"setPaymentDetails"|"addWittnessedTx"|"setMerchantNotes"|undefined} action
             * @memberof market.mass.UpdateOrder
             * @instance
             */
            Object.defineProperty(UpdateOrder.prototype, "action", {
                get: $util.oneOfGetter($oneOfFields = ["cancel", "changeItems", "commitItems", "setInvoiceAddress", "setShippingAddress", "choosePayment", "setPaymentDetails", "addWittnessedTx", "setMerchantNotes"]),
                set: $util.oneOfSetter($oneOfFields)
            });
            ...
            UpdateOrder.encode = function encode(message, writer) {
                ...
                if (message.cancel != null && Object.hasOwnProperty.call(message, "cancel"))
                    $root.market.mass.UpdateOrder.Cancel.encode(message.cancel, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
                ...
                if (message.commitItems != null && Object.hasOwnProperty.call(message, "commitItems"))
                    $root.market.mass.UpdateOrder.CommitItems.encode(message.commitItems, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
                if (message.setInvoiceAddress != null && Object.hasOwnProperty.call(message, "setInvoiceAddress"))
                    $root.market.mass.AddressDetails.encode(message.setInvoiceAddress, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
                if (message.setShippingAddress != null && Object.hasOwnProperty.call(message, "setShippingAddress"))
                    $root.market.mass.AddressDetails.encode(message.setShippingAddress, writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
                if (message.choosePayment != null && Object.hasOwnProperty.call(message, "choosePayment"))
                    $root.market.mass.UpdateOrder.ChoosePaymentMethod.encode(message.choosePayment, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
                if (message.setPaymentDetails != null && Object.hasOwnProperty.call(message, "setPaymentDetails"))
                    $root.market.mass.PaymentDetails.encode(message.setPaymentDetails, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
                if (message.addWittnessedTx != null && Object.hasOwnProperty.call(message, "addWittnessedTx"))
                    $root.market.mass.OrderTransaction.encode(message.addWittnessedTx, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
                if (message.setMerchantNotes != null && Object.hasOwnProperty.call(message, "setMerchantNotes"))
                    writer.uint32(/* id 10, wireType 2 =*/82).string(message.setMerchantNotes);
                return writer;
            };
            ...
            UpdateOrder.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 2: {
                            message.cancel = $root.market.mass.UpdateOrder.Cancel.decode(reader, reader.uint32());
                            break;
                        }
                    case 3: {
                    ...
                    case 4: {
                            message.commitItems = $root.market.mass.UpdateOrder.CommitItems.decode(reader, reader.uint32());
                            break;
                        }
                    case 5: {
                            message.setInvoiceAddress = $root.market.mass.AddressDetails.decode(reader, reader.uint32());
                            break;
                        }
                    case 6: {
                            message.setShippingAddress = $root.market.mass.AddressDetails.decode(reader, reader.uint32());
                            break;
                        }
                    case 7: {
                            message.choosePayment = $root.market.mass.UpdateOrder.ChoosePaymentMethod.decode(reader, reader.uint32());
                            break;
                        }
                    case 8: {
                            message.setPaymentDetails = $root.market.mass.PaymentDetails.decode(reader, reader.uint32());
                            break;
                        }
                    case 9: {
                            message.addWittnessedTx = $root.market.mass.OrderTransaction.decode(reader, reader.uint32());
                            break;
                        }
                    case 10: {
                            message.setMerchantNotes = reader.string();
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            UpdateOrder.verify = function verify(message) {
                ...
                if (message.cancel != null && message.hasOwnProperty("cancel")) {
                    properties.action = 1;
                    {
                        var error = $root.market.mass.UpdateOrder.Cancel.verify(message.cancel);
                        if (error)
                            return "cancel." + error;
                    }
                }
                ...
                if (message.commitItems != null && message.hasOwnProperty("commitItems")) {
                    if (properties.action === 1)
                        return "action: multiple values";
                    properties.action = 1;
                    {
                        var error = $root.market.mass.UpdateOrder.CommitItems.verify(message.commitItems);
                        if (error)
                            return "commitItems." + error;
                    }
                }
                if (message.setInvoiceAddress != null && message.hasOwnProperty("setInvoiceAddress")) {
                    if (properties.action === 1)
                        return "action: multiple values";
                    properties.action = 1;
                    {
                        var error = $root.market.mass.AddressDetails.verify(message.setInvoiceAddress);
                        if (error)
                            return "setInvoiceAddress." + error;
                    }
                }
                if (message.setShippingAddress != null && message.hasOwnProperty("setShippingAddress")) {
                    if (properties.action === 1)
                        return "action: multiple values";
                    properties.action = 1;
                    {
                        var error = $root.market.mass.AddressDetails.verify(message.setShippingAddress);
                        if (error)
                            return "setShippingAddress." + error;
                    }
                }
                if (message.choosePayment != null && message.hasOwnProperty("choosePayment")) {
                    if (properties.action === 1)
                        return "action: multiple values";
                    properties.action = 1;
                    {
                        var error = $root.market.mass.UpdateOrder.ChoosePaymentMethod.verify(message.choosePayment);
                        if (error)
                            return "choosePayment." + error;
                    }
                }
                if (message.setPaymentDetails != null && message.hasOwnProperty("setPaymentDetails")) {
                    if (properties.action === 1)
                        return "action: multiple values";
                    properties.action = 1;
                    {
                        var error = $root.market.mass.PaymentDetails.verify(message.setPaymentDetails);
                        if (error)
                            return "setPaymentDetails." + error;
                    }
                }
                if (message.addWittnessedTx != null && message.hasOwnProperty("addWittnessedTx")) {
                    if (properties.action === 1)
                        return "action: multiple values";
                    properties.action = 1;
                    {
                        var error = $root.market.mass.OrderTransaction.verify(message.addWittnessedTx);
                        if (error)
                            return "addWittnessedTx." + error;
                    }
                }
                if (message.setMerchantNotes != null && message.hasOwnProperty("setMerchantNotes")) {
                    if (properties.action === 1)
                        return "action: multiple values";
                    properties.action = 1;
                    if (!$util.isString(message.setMerchantNotes))
                        return "setMerchantNotes: string expected";
                }
                return null;
            };
            ...
            UpdateOrder.fromObject = function fromObject(object) {
                ...
                if (object.cancel != null) {
                    ...
                    message.cancel = $root.market.mass.UpdateOrder.Cancel.fromObject(object.cancel);
                }
                ...
                if (object.commitItems != null) {
                    if (typeof object.commitItems !== "object")
                        throw TypeError(".market.mass.UpdateOrder.commitItems: object expected");
                    message.commitItems = $root.market.mass.UpdateOrder.CommitItems.fromObject(object.commitItems);
                }
                if (object.setInvoiceAddress != null) {
                    if (typeof object.setInvoiceAddress !== "object")
                        throw TypeError(".market.mass.UpdateOrder.setInvoiceAddress: object expected");
                    message.setInvoiceAddress = $root.market.mass.AddressDetails.fromObject(object.setInvoiceAddress);
                }
                if (object.setShippingAddress != null) {
                    if (typeof object.setShippingAddress !== "object")
                        throw TypeError(".market.mass.UpdateOrder.setShippingAddress: object expected");
                    message.setShippingAddress = $root.market.mass.AddressDetails.fromObject(object.setShippingAddress);
                }
                if (object.choosePayment != null) {
                    if (typeof object.choosePayment !== "object")
                        throw TypeError(".market.mass.UpdateOrder.choosePayment: object expected");
                    message.choosePayment = $root.market.mass.UpdateOrder.ChoosePaymentMethod.fromObject(object.choosePayment);
                }
                if (object.setPaymentDetails != null) {
                    if (typeof object.setPaymentDetails !== "object")
                        throw TypeError(".market.mass.UpdateOrder.setPaymentDetails: object expected");
                    message.setPaymentDetails = $root.market.mass.PaymentDetails.fromObject(object.setPaymentDetails);
                }
                if (object.addWittnessedTx != null) {
                    if (typeof object.addWittnessedTx !== "object")
                        throw TypeError(".market.mass.UpdateOrder.addWittnessedTx: object expected");
                    message.addWittnessedTx = $root.market.mass.OrderTransaction.fromObject(object.addWittnessedTx);
                }
                if (object.setMerchantNotes != null)
                    message.setMerchantNotes = String(object.setMerchantNotes);
                return message;
            };
            ...
            UpdateOrder.toObject = function toObject(message, options) {
                ...
                if (message.id != null && message.hasOwnProperty("id"))
                    object.id = $root.market.mass.ObjectId.toObject(message.id, options);
                if (message.cancel != null && message.hasOwnProperty("cancel")) {
                    object.cancel = $root.market.mass.UpdateOrder.Cancel.toObject(message.cancel, options);
                    if (options.oneofs)
                ...
                if (message.commitItems != null && message.hasOwnProperty("commitItems")) {
                    object.commitItems = $root.market.mass.UpdateOrder.CommitItems.toObject(message.commitItems, options);
                    if (options.oneofs)
                        object.action = "commitItems";
                }
                if (message.setInvoiceAddress != null && message.hasOwnProperty("setInvoiceAddress")) {
                    object.setInvoiceAddress = $root.market.mass.AddressDetails.toObject(message.setInvoiceAddress, options);
                    if (options.oneofs)
                        object.action = "setInvoiceAddress";
                }
                if (message.setShippingAddress != null && message.hasOwnProperty("setShippingAddress")) {
                    object.setShippingAddress = $root.market.mass.AddressDetails.toObject(message.setShippingAddress, options);
                    if (options.oneofs)
                        object.action = "setShippingAddress";
                }
                if (message.choosePayment != null && message.hasOwnProperty("choosePayment")) {
                    object.choosePayment = $root.market.mass.UpdateOrder.ChoosePaymentMethod.toObject(message.choosePayment, options);
                    if (options.oneofs)
                        object.action = "choosePayment";
                }
                if (message.setPaymentDetails != null && message.hasOwnProperty("setPaymentDetails")) {
                    object.setPaymentDetails = $root.market.mass.PaymentDetails.toObject(message.setPaymentDetails, options);
                    if (options.oneofs)
                        object.action = "setPaymentDetails";
                }
                if (message.addWittnessedTx != null && message.hasOwnProperty("addWittnessedTx")) {
                    object.addWittnessedTx = $root.market.mass.OrderTransaction.toObject(message.addWittnessedTx, options);
                    if (options.oneofs)
                        object.action = "addWittnessedTx";
                }
                if (message.setMerchantNotes != null && message.hasOwnProperty("setMerchantNotes")) {
                    object.setMerchantNotes = message.setMerchantNotes;
                    if (options.oneofs)
                        object.action = "setMerchantNotes";
                }
                return object;
            };
            ...
            UpdateOrder.Cancel = (function() {
                ...
                Cancel.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateOrder.Cancel();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        default:
            ...
            UpdateOrder.ChoosePaymentMethod = (function() {
                 ...
                 * @returns {$protobuf.Writer} Writer
                 */
                ChoosePaymentMethod.encodeDelimited = function encodeDelimited(message, writer) {
                    return this.encode(message, writer).ldelim();
                };
                ...
                ChoosePaymentMethod.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateOrder.ChoosePaymentMethod();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                ChoosePaymentMethod.fromObject = function fromObject(object) {
                    if (object instanceof $root.market.mass.UpdateOrder.ChoosePaymentMethod)
                        return object;
                    var message = new $root.market.mass.UpdateOrder.ChoosePaymentMethod();
                    if (object.currency != null) {
                        if (typeof object.currency !== "object")
                            throw TypeError(".market.mass.UpdateOrder.ChoosePaymentMethod.currency: object expected");
                    ...
                    if (object.payee != null) {
                        if (typeof object.payee !== "object")
                            throw TypeError(".market.mass.UpdateOrder.ChoosePaymentMethod.payee: object expected");
