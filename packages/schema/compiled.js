        ...
        market.mass = (function() {
            ...
            mass.Envelope = (function() {
                ...
                Envelope.verify = function verify(message) {
                    ...
                    if (message.patchSetWriteRequest != null && message.hasOwnProperty("patchSetWriteRequest")) {
                        ...
                        properties.message = 1;
                        {
                            var error = $root.market.mass.PatchSetWriteRequest.verify(message.patchSetWriteRequest);
                            if (error)
            ...
            mass.SubscriptionPushRequest = (function() {
                ...
                SubscriptionPushRequest.encode = function encode(message, writer) {
                    ...
                    if (message.patches != null && message.patches.length)
                        for (var i = 0; i < message.patches.length; ++i)
                    ...
                    if (message.patchSetMeta != null && Object.hasOwnProperty.call(message, "patchSetMeta"))
                        for (var keys = Object.keys(message.patchSetMeta), i = 0; i < keys.length; ++i) {
                ...
                SubscriptionPushRequest.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.SubscriptionPushRequest(), key, value;
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                SubscriptionPushRequest.verify = function verify(message) {
                    ...
                    if (message.patches != null && message.hasOwnProperty("patches")) {
                        ...
                        for (var i = 0; i < message.patches.length; ++i) {
                            var error = $root.market.mass.SubscriptionPushRequest.SequencedPatch.verify(message.patches[i]);
                            if (error)
                    ...
                    if (message.patchSetMeta != null && message.hasOwnProperty("patchSetMeta")) {
                        ...
                        var key = Object.keys(message.patchSetMeta);
                        for (var i = 0; i < key.length; ++i) {
                            if (!$util.key64Re.test(key[i]))
                                return "patchSetMeta: integer|Long key{k:uint64} expected";
                            {
                                var error = $root.market.mass.SubscriptionPushRequest.PatchSetMeta.verify(message.patchSetMeta[key[i]]);
                                if (error)
                ...
                SubscriptionPushRequest.fromObject = function fromObject(object) {
                    ...
                    if (object.patches) {
                        ...
                        message.patches = [];
                        for (var i = 0; i < object.patches.length; ++i) {
                    ...
                    if (object.patchSetMeta) {
                        ...
                        message.patchSetMeta = {};
                        for (var keys = Object.keys(object.patchSetMeta), i = 0; i < keys.length; ++i) {
                ...
                SubscriptionPushRequest.toObject = function toObject(message, options) {
                    ...
                    if (message.patches && message.patches.length) {
                        object.patches = [];
                        for (var j = 0; j < message.patches.length; ++j)
                ...
                SubscriptionPushRequest.SequencedPatch = (function() {
                    ...
                    SequencedPatch.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.SubscriptionPushRequest.SequencedPatch();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1: {
                    ...
                    SequencedPatch.fromObject = function fromObject(object) {
                        if (object instanceof $root.market.mass.SubscriptionPushRequest.SequencedPatch)
                            return object;
                        var message = new $root.market.mass.SubscriptionPushRequest.SequencedPatch();
                ...
                SubscriptionPushRequest.PatchSetMeta = (function() {
                    ...
                    PatchSetMeta.decode = function decode(reader, length) {
                        if (!(reader instanceof $Reader))
                            reader = $Reader.create(reader);
                        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.SubscriptionPushRequest.PatchSetMeta();
                        while (reader.pos < end) {
                            var tag = reader.uint32();
                            switch (tag >>> 3) {
                            case 1: {
                    ...
                    PatchSetMeta.fromObject = function fromObject(object) {
                        if (object instanceof $root.market.mass.SubscriptionPushRequest.PatchSetMeta)
                            return object;
                        var message = new $root.market.mass.SubscriptionPushRequest.PatchSetMeta();
            ...
            mass.PatchSetWriteRequest = (function() {
                ...
                PatchSetWriteRequest.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.PatchSetWriteRequest();
                    while (reader.pos < end) {
                        var tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                PatchSetWriteRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.market.mass.PatchSetWriteRequest)
                        return object;
                    var message = new $root.market.mass.PatchSetWriteRequest();
