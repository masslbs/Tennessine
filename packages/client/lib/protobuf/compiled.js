    ...
    market.mass = (function() {
        ...
        mass.ShopManifest = (function() {
            ...
            ShopManifest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.ShopManifest();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.UpdateShopManifest = (function() {
            ...
            UpdateShopManifest.encode = function encode(message, writer) {
                ...
                if (message.addErc20Addr != null && Object.hasOwnProperty.call(message, "addErc20Addr"))
                    writer.uint32(/* id 4, wireType 2 =*/34).bytes(message.addErc20Addr);
                if (message.removeErc20Addr != null && Object.hasOwnProperty.call(message, "removeErc20Addr"))
                    writer.uint32(/* id 5, wireType 2 =*/42).bytes(message.removeErc20Addr);
                return writer;
            };
            ...
            UpdateShopManifest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateShopManifest();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            UpdateShopManifest.verify = function verify(message) {
                ...
                if (message.addErc20Addr != null && message.hasOwnProperty("addErc20Addr")) {
                    properties._addErc20Addr = 1;
                    if (!(message.addErc20Addr && typeof message.addErc20Addr.length === "number" || $util.isString(message.addErc20Addr)))
                        return "addErc20Addr: buffer expected";
                }
                if (message.removeErc20Addr != null && message.hasOwnProperty("removeErc20Addr")) {
                    properties._removeErc20Addr = 1;
                    if (!(message.removeErc20Addr && typeof message.removeErc20Addr.length === "number" || $util.isString(message.removeErc20Addr)))
            ...
            UpdateShopManifest.fromObject = function fromObject(object) {
                ...
                if (object.addErc20Addr != null)
                    if (typeof object.addErc20Addr === "string")
                        $util.base64.decode(object.addErc20Addr, message.addErc20Addr = $util.newBuffer($util.base64.length(object.addErc20Addr)), 0);
                ...
                if (object.removeErc20Addr != null)
                    if (typeof object.removeErc20Addr === "string")
                        $util.base64.decode(object.removeErc20Addr, message.removeErc20Addr = $util.newBuffer($util.base64.length(object.removeErc20Addr)), 0);
            ...
            UpdateShopManifest.toObject = function toObject(message, options) {
                ...
                if (message.addErc20Addr != null && message.hasOwnProperty("addErc20Addr")) {
                    object.addErc20Addr = options.bytes === String ? $util.base64.encode(message.addErc20Addr, 0, message.addErc20Addr.length) : options.bytes === Array ? Array.prototype.slice.call(message.addErc20Addr) : message.addErc20Addr;
                    if (options.oneofs)
                        object._addErc20Addr = "addErc20Addr";
                }
                if (message.removeErc20Addr != null && message.hasOwnProperty("removeErc20Addr")) {
                    object.removeErc20Addr = options.bytes === String ? $util.base64.encode(message.removeErc20Addr, 0, message.removeErc20Addr.length) : options.bytes === Array ? Array.prototype.slice.call(message.removeErc20Addr) : message.removeErc20Addr;
                    if (options.oneofs)
                        object._removeErc20Addr = "removeErc20Addr";
                }
                return object;
            };
        ...
        mass.UpdateTag = (function() {
            ...
            UpdateTag.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateTag();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.CreateOrder = (function() {
            ...
            CreateOrder.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.CreateOrder();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.UpdateOrder = (function() {
            ...
            UpdateOrder.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateOrder();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            UpdateOrder.verify = function verify(message) {
                ...
                if (message.changeItems != null && message.hasOwnProperty("changeItems")) {
                    properties.action = 1;
                    {
                        let error = $root.market.mass.UpdateOrder.ChangeItems.verify(message.changeItems);
                        if (error)
                ...
                if (message.itemsFinalized != null && message.hasOwnProperty("itemsFinalized")) {
                    ...
                    properties.action = 1;
                    {
                        let error = $root.market.mass.UpdateOrder.ItemsFinalized.verify(message.itemsFinalized);
                        if (error)
                ...
                if (message.orderCanceled != null && message.hasOwnProperty("orderCanceled")) {
                    ...
                    properties.action = 1;
                    {
                        let error = $root.market.mass.UpdateOrder.OrderCanceled.verify(message.orderCanceled);
                        if (error)
            ...
            UpdateOrder.ChangeItems = (function() {
                ...
                ChangeItems.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateOrder.ChangeItems();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
            ...
            UpdateOrder.ItemsFinalized = (function() {
                ...
                ItemsFinalized.encode = function encode(message, writer) {
                    ...
                    if (message.totalInCrypto != null && Object.hasOwnProperty.call(message, "totalInCrypto"))
                        writer.uint32(/* id 8, wireType 2 =*/66).string(message.totalInCrypto);
                ...
                ItemsFinalized.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateOrder.ItemsFinalized();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
            ...
            UpdateOrder.OrderCanceled = (function() {
                ...
                OrderCanceled.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateOrder.OrderCanceled();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
        ...
        mass.ShopEvent = (function() {
            ...
            ShopEvent.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.ShopEvent();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
            ...
            ShopEvent.verify = function verify(message) {
                ...
                if (message.shopManifest != null && message.hasOwnProperty("shopManifest")) {
                    properties.union = 1;
                    {
                        let error = $root.market.mass.ShopManifest.verify(message.shopManifest);
                        if (error)
                ...
                if (message.updateShopManifest != null && message.hasOwnProperty("updateShopManifest")) {
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.UpdateShopManifest.verify(message.updateShopManifest);
                        if (error)
                ...
                if (message.createOrder != null && message.hasOwnProperty("createOrder")) {
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.CreateOrder.verify(message.createOrder);
                        if (error)
                ...
                if (message.updateOrder != null && message.hasOwnProperty("updateOrder")) {
                    ...
                    properties.union = 1;
                    {
                        let error = $root.market.mass.UpdateOrder.verify(message.updateOrder);
                        if (error)
        ...
        mass.CommitItemsToOrderRequest = (function() {
             ...
             * @instance
             */
            CommitItemsToOrderRequest.prototype.chainId = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
            ...
            CommitItemsToOrderRequest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.CommitItemsToOrderRequest();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.CommitItemsToOrderResponse = (function() {
            ...
            CommitItemsToOrderResponse.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.CommitItemsToOrderResponse();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
