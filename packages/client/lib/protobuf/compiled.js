...
export const market = $root.market = (() => {
    ...
    market.mass = (function() {
        ...
        mass.UpdateStoreManifest = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            UpdateStoreManifest.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            UpdateStoreManifest.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.UpdateStoreManifest();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
        ...
        mass.StoreEvent = (function() {
            ...
            Object.defineProperty(StoreEvent.prototype, "union", {
                get: $util.oneOfGetter($oneOfFields = ["storeManifest", "updateStoreManifest", "createItem", "updateItem", "createTag", "updateTag", "createOrder", "updateOrder", "changeStock", "newKeyCard"]),
                set: $util.oneOfSetter($oneOfFields)
            });
            ...
            StoreEvent.encode = function encode(message, writer) {
                ...
                if (message.updateStoreManifest != null && Object.hasOwnProperty.call(message, "updateStoreManifest"))
                    $root.market.mass.UpdateStoreManifest.encode(message.updateStoreManifest, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            ...
            StoreEvent.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.market.mass.StoreEvent();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
                    ...
                    case 3: {
                            message.updateStoreManifest = $root.market.mass.UpdateStoreManifest.decode(reader, reader.uint32());
                            break;
                        }
                    case 4: {
            ...
            StoreEvent.verify = function verify(message) {
                ...
                if (message.updateStoreManifest != null && message.hasOwnProperty("updateStoreManifest")) {
                    if (properties.union === 1)
                        return "union: multiple values";
                    properties.union = 1;
                    {
                        let error = $root.market.mass.UpdateStoreManifest.verify(message.updateStoreManifest);
                        if (error)
                            return "updateStoreManifest." + error;
                    }
                }
            ...
            StoreEvent.fromObject = function fromObject(object) {
                if (object instanceof $root.market.mass.StoreEvent)
                    return object;
                ...
                if (object.storeManifest != null) {
                    if (typeof object.storeManifest !== "object")
                        throw TypeError(".market.mass.StoreEvent.storeManifest: object expected");
                ...
                if (object.updateStoreManifest != null) {
                    if (typeof object.updateStoreManifest !== "object")
                        throw TypeError(".market.mass.StoreEvent.updateStoreManifest: object expected");
                    message.updateStoreManifest = $root.market.mass.UpdateStoreManifest.fromObject(object.updateStoreManifest);
                }
                if (object.createItem != null) {
                    if (typeof object.createItem !== "object")
                        throw TypeError(".market.mass.StoreEvent.createItem: object expected");
                ...
                if (object.updateItem != null) {
                    if (typeof object.updateItem !== "object")
                        throw TypeError(".market.mass.StoreEvent.updateItem: object expected");
                ...
                if (object.createTag != null) {
                    if (typeof object.createTag !== "object")
                        throw TypeError(".market.mass.StoreEvent.createTag: object expected");
                ...
                if (object.updateTag != null) {
                    if (typeof object.updateTag !== "object")
                        throw TypeError(".market.mass.StoreEvent.updateTag: object expected");
                ...
                if (object.createOrder != null) {
                    if (typeof object.createOrder !== "object")
                        throw TypeError(".market.mass.StoreEvent.createOrder: object expected");
                ...
                if (object.updateOrder != null) {
                    if (typeof object.updateOrder !== "object")
                        throw TypeError(".market.mass.StoreEvent.updateOrder: object expected");
                ...
                if (object.changeStock != null) {
                    if (typeof object.changeStock !== "object")
                        throw TypeError(".market.mass.StoreEvent.changeStock: object expected");
                ...
                if (object.newKeyCard != null) {
                    if (typeof object.newKeyCard !== "object")
                        throw TypeError(".market.mass.StoreEvent.newKeyCard: object expected");
            ...
            StoreEvent.toObject = function toObject(message, options) {
                ...
                if (message.updateStoreManifest != null && message.hasOwnProperty("updateStoreManifest")) {
                    object.updateStoreManifest = $root.market.mass.UpdateStoreManifest.toObject(message.updateStoreManifest, options);
                    if (options.oneofs)
                        object.union = "updateStoreManifest";
                }
                if (message.createItem != null && message.hasOwnProperty("createItem")) {
