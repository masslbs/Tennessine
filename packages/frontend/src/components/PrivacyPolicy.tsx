  ...
  return (
    <main className="px-4 flex justify-center">
      <section className="md:w-[800px] w-full">
        ...
        <h1 className="py-3">Privacy Notice</h1>
        <section className="mt-2 flex flex-col gap-1 bg-white p-5 rounded-lg">
          <em>Last updated 8th May 2025</em>
          <p>
            This privacy notice for Mass Labs (doing business as Mass Market)
          ...
          <p>
            ...
            questions or concerns, please contact us at info@mass.market.
          </p>
          ...
          <p>
            ...
            Services, communicate with you, and to comply with law. We process
          ...
          <p>
            ...
            categories of third parties who provide services to us, for example
            providing hosting or privacy-aware usage analytics.
          </p>
          ...
          <p>
            <b>
              Want to learn more about what Mass Labs does with any information
              we collect?
            </b>{" "}
          ...
          <ol>
            ...
            <li>15. Do we make updates to this notice?</li>
            <li>16. How can you contact us about this notice?</li>
            <li>
          ...
          <p>
            ...
            our products and Services, when you use any of our website or
          ...
          <p>
            ...
            payment if you make purchases, such as your cryptocurrency wallet
            address that you paid from, cryptocurrency wallet address that you
            paid to, the chain and token used for payment, and amount of token
            transacted. All payment data is stored on the blockchain, which is a
            public ledger of transactions. Data identifying what was purchased
            or where it was delivered to is not stored on the blockchain.
          </p>
          ...
          <p>
            <b>In Short:</b>{" "}
            We process your information to provide, improve, and administer our
            Services, communicate with you and to comply with law.
          </p>
          ...
          <p>
            ...
            of the data processing we perform.
          </p>
          ...
          <p>
            We make every effort to self-host open-source tools where possible.
            Where we cannot, we have contracts in place with our third parties,
            which are designed to help safeguard your personal information. This
            means that they cannot do anything with your personal information
            unless we have instructed them to do it. They will also not share
            your personal information with any organization apart from us. They
            also commit to protect the data they hold on our behalf and to
            retain it for the period we instruct.
          </p>

          <p>
            The categories of self-hosted open source tools or third-party
            service providers that we may share personal information with are as
            follows:
          </p>
          ...
          <p>
            ...
            mobile applications that are not affiliated with us and which may
            link to other websites, services, or applications. Accordingly, we
            do not make any guarantee regarding any such third parties, and we
            will not be liable for any loss or damage caused by the use of such
          ...
          <p>
            ...
            store information. We do not use any Google Analytics services. We
          ...
          <p>
            Our servers are located in Europe. If you are accessing our Services
            from outside Europe, please be aware that your information may be
            ...
            (see "When and with whom do we share your information?" above), in
            other countries. Please be aware that any financial transactions you
            make using distributed ledger technologies are stored on multiple
            nodes located in multiple countries and regions around the world. If
            you are a resident in the European Economic Area (EEA) or United
          ...
          <p>
            ...
            been collected, we will take reasonable measures to promptly delete
          ...
          <p>
            ...
            unsubscribe from our newsletters and other promotional
            ...
            below. You will then be removed from the mailing lists — however, we
            may still communicate with you for fulfillment of requested services
          ...
          <p>
            <b>In Short:</b>{" "}
            Yes, if you are a resident of California, Colorado, Connecticut,
          ...
          <p>
            Learn more about how we share your personal information in sections
            4 and 5 above.
          </p>
          ...
          <p>
            You may contact us by email at info@mass.market.
          </p>
          ...
          <p>
            Depending on the state where you live, you may also have the
            following rights:
          </p>
          ...
          <p>
            ...
            info@mass.market, or by referring to the contact details at the
            bottom of this document.
          </p>

          <p>
            Under certain US state data protection laws, you can designate and
          ...
          <p>
            ...
            communication method (e.g., email) that you have previously provided
          ...
          <p>
            ...
            New Zealand's Privacy Act 2020. This Privacy Notice satisfies the
            notice requirements defined in both Privacy Acts.
          </p>
          ...
          <p>
            ...
            informatio, you have the right to submit a complaint about a breach
          ...
          <p>
            At any time, you have the right to request access to or correction
            of your personal inforamtion. You can make such a request by
            contacting us using the contact details provided below. If you are
            unsatisfied with the manner in which we address any complaint with
            regard to our processing of personal information, you can contact
          ...
          <p>
            <b>In Short:</b>{" "}
            Yes, we will update this notice as necessary – as new features and
            services are developed and to stay compliant with relevant laws.
          </p>
          ...
          <p>
            ...
            please write to us at: info@mass.market.
          </p>
        </section>
      </section>
    </main>
